...
function tableToGrid(a, b) {
    jQuery(a).each(function() {
        if (!this.grid) {
            ...
            b || {})), a = 0; a < h.length; a++) d = null,
            0 < i.length && (d = i[a]) && d.replace && (d = encodeURIComponent(d).replace(/[.\-%]/g, "_")),
            null === d && (d = a + 1),
...
function(b) {
    ...
    b.extend(b.jgrid, {
        ...
        msiever: function() {
            var a = -1;
            return null != /MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent) && (a = parseFloat(RegExp.$1)),
            a
        },
        getCellIndex: function(a) {
            return a = b(a),
            a.is("tr") ? -1 : (a = (a.is("td") || a.is("th") ? a: a.closest("td,th"))[0], b.jgrid.msie ? b.inArray(a, a.parentNode.cells) : a.cellIndex)
        },
        ...
        stripPref: function(a, c) {
            var d = b.type(a);
            return ("string" === d || "number" === d) && (a = "" + a, c = "" !== a ? ("" + c).replace("" + a, "") : c),
            c
        },
        parse: function(d) {
            return "while(1);" === d.substr(0, 9) && (d = d.substr(9)),
            "/*" === d.substr(0, 2) && (d = d.substr(2, d.length - 4)),
            d || (d = "{}"),
            !0 === b.jgrid.useJSON && "object" == typeof JSON && "function" == typeof JSON.parse ? JSON.parse(d) : eval("(" + d + ")")
        },
        parseDate: function(a, c, d, e) {
            ...
            else if (null !== i) k = new Date(parseInt(i[1], 10)),
            i[3] && (a = 60 * Number(i[5]) + Number(i[6]), a *= "-" === i[4] ? 1 : -1, a -= k.getTimezoneOffset(), k.setTime(Number(Number(k) + 6e4 * a)));
            else {
                for (c = ("" + c).replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe), a = a.replace(/\\T/g, "T").replace(/\\t/, "t").split(e.parseRe), f = 0, g = a.length; g > f; f++)"M" === a[f] && (i = b.inArray(c[f], e.monthNames), -1 !== i && 12 > i && (c[f] = i + 1, j.m = c[f])),
                "F" === a[f] && (i = b.inArray(c[f], e.monthNames, 12), -1 !== i && i > 11 && (c[f] = i + 1 - 12, j.m = c[f])),
                "a" === a[f] && (i = b.inArray(c[f], e.AmPm), -1 !== i && 2 > i && c[f] === e.AmPm[i] && (c[f] = i, j.h = k(c[f], j.h))),
                "A" === a[f] && (i = b.inArray(c[f], e.AmPm), -1 !== i && i > 1 && c[f] === e.AmPm[i] && (c[f] = i - 2, j.h = k(c[f], j.h))),
                "g" === a[f] && (j.h = parseInt(c[f], 10)),
                void 0 !== c[f] && (j[a[f].toLowerCase()] = parseInt(c[f], 10));
                if (j.f && (j.m = j.f), 0 === j.m && 0 === j.y && 0 === j.d) return "&#160;";
                j.m = parseInt(j.m, 10) - 1,
                k = j.y,
                k >= 70 && 99 >= k ? j.y = 1900 + j.y: k >= 0 && 69 >= k && (j.y = 2e3 + j.y),
        ...
        from: function(d) {
            ...
            function(d, c) {
                ...
                return 0 < d.length && (E = "object" != typeof d[0] ? !1 : !0),
                this._hasData = function() {
                    return null === a ? !1 : 0 === a.length ? !1 : !0
                },
                this._getStr = function(a) {
                    var b = [];
                    return f && b.push("jQuery.trim("),
                    b.push("String(" + a + ")"),
                    f && b.push(")"),
                ...
                this._compare = function(a, b, c) {
                    ...
                    void 0 === a && (a = null),
                    void 0 === b && (b = null),
                    null === a && null === b ? 0 : null === a && null !== b ? 1 : null !== a && null === b ? -1 : "[object Date]" === d.call(a) && "[object Date]" === d.call(b) ? b > a ? -c: a > b ? c: 0 : (!i && "number" != typeof a && "number" != typeof b && (a = "" + a, b = "" + b), b > a ? -c: a > b ? c: 0)
                },
                ...
                this._getOrder = function(a, c, d, f, g) {
                    ...
                    n = "a" === d ? 1 : -1;
                    void 0 === f && (f = "text"),
                    k = "float" === f || "number" === f || "currency" === f || "numeric" === f ?
                    function(a) {
                        return a = parseFloat(("" + a).replace(j, "")),
                        isNaN(a) ? 0 : a
                    }: "int" === f || "integer" === f ?
                    function(a) {
                ...
                this._getGroup = function(a, c, d, f, g) {
                    ...
                    j = null,
                    k = null;
                    return b.each(e._getOrder(a, c, d, f, g),
                    function(a, d) {
                        h = b.jgrid.getAccessor(d, c),
                        null == h && (h = ""),
                        e._equals(k, h) || (k = h, null !== j && i.push(j), j = e._group(c, h)),
                        j.items.push(d)
                    }),
                    null !== j && i.push(j),
                    i
                ...
                this.and = function(a, b, c) {
                    return r = " && ",
                    void 0 === a ? e: e._repeatCommand(a, b, c)
                },
                ...
                this.startsWith = function(a, c) {
                    ...
                    return E ? e._append(e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(0," + d + ") == " + e._getStr('"' + e._toStr(c) + '"')) : (d = f ? b.trim(c.toString()).length: c.toString().length, e._append(e._getStr("this") + ".substr(0," + d + ") == " + e._getStr('"' + e._toStr(a) + '"'))),
                ...
                this.endsWith = function(a, c) {
                    var d = null == c ? a: c,
                    d = f ? b.trim(d.toString()).length: d.toString().length;
                    return e._append(E ? e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".substr(" + e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + ".length-" + d + "," + d + ') == "' + e._toStr(c) + '"': e._getStr("this") + ".substr(" + e._getStr("this") + '.length-"' + e._toStr(a) + '".length,"' + e._toStr(a) + '".length) == "' + e._toStr(a) + '"'),
                    e._setCommand(e.endsWith, a),
                    e._resetNegate(),
                    e
                },
                this.contains = function(a, b) {
                    return e._append(E ? e._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + e._toStr(b) + '",0) > -1': e._getStr("this") + '.indexOf("' + e._toStr(a) + '",0) > -1'),
                ...
                this.orderBy = function(a, c, d, f) {
                    return c = null == c ? "a": b.trim(c.toString().toLowerCase()),
                    null == d && (d = "text"),
                    null == f && (f = "Y-m-d"),
        ...
        extend: function(a) {
            b.extend(b.fn.jqGrid, a),
            this.no_legacy_api || b.fn.extend(a)
        }
    }),
            ...
            if (!this.grid) {
                ...
                e = {
                    ...
                    dragEnd: function() {
                        if (this.hDiv.style.cursor = "default", this.resizing) {
                            ...
                            0 < this.footers.length && (this.footers[a].style.width = e + "px"),
                            !0 === c.forceFit ? (e = this.headers[a + c.nv].newWidth || this.headers[a + c.nv].width, this.headers[a + c.nv].width = e, this.headers[a + c.nv].el.style.width = e + "px", this.cols[a + c.nv].style.width = e + "px", 0 < this.footers.length && (this.footers[a + c.nv].style.width = e + "px"), c.colModel[a + c.nv].width = e) : (c.tblwidth = this.newWidth || c.tblwidth, b("table:first", this.bDiv).css("width", c.tblwidth + "px"), b("table:first", this.hDiv).css("width", c.tblwidth + "px"), this.hDiv.scrollLeft = this.bDiv.scrollLeft, c.footerrow && (b("table:first", this.sDiv).css("width", c.tblwidth + "px"), this.sDiv.scrollLeft = this.bDiv.scrollLeft)),
                    ...
                    populateVisible: function() {
                        ...
                        if (a) {
                            ...
                            if (f) {
                                ...
                                f *= i;
                                var l, m, n;
                                a > k && 0 >= j && (void 0 === c.lastpage || parseInt((k + d + f - 1) / f, 10) <= c.lastpage) && (m = parseInt((a - k + f - 1) / f, 10), k >= 0 || 2 > m || !0 === c.scroll ? (l = Math.round((k + d) / f) + 1, j = -1) : j = 1),
                                j > 0 && (l = parseInt(d / f, 10) + 1, m = parseInt((d + a) / f, 10) + 2 - l, n = !0),
                                !m || c.lastpage && (l > c.lastpage || 1 === c.lastpage || l === c.page && l === c.lastpage) || (e.hDiv.loading ? e.timer = setTimeout(e.populateVisible, c.scrollTimeout) : (c.page = l, n && (e.selectionPreserver(g[0]), e.emptyRows.call(g[0], !1, !1)), e.populate(m)))
                            }
                        }
                    },
                ...
                if ("TABLE" !== this.tagName.toUpperCase()) alert("Element is not a table");
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        -1 === b.inArray(d.p.direction, ["ltr", "rtl"]) && (d.p.direction = "ltr"),
                        g = d.p.direction,
                        ...
                        b(h).attr("id", "gview_" + this.id).appendTo(j),
                        b("<div class='ui-widget-overlay jqgrid-overlay' id='lui_" + this.id + "'></div>").insertBefore(h),
                        b("<div class='loading ui-state-default ui-state-active' id='load_" + this.id + "'>" + this.p.loadtext + "</div>").insertBefore(h),
                        b(this).attr({
                            cellspacing: "0",
                            cellpadding: "0",
                            border: "0",
                        ...
                        n = function(a, c, e, f, g) {
                            ...
                            c = b.isFunction(h.formatter) ? h.formatter.call(d, c, a, f, g) : b.fmatter ? b.fn.fmatter.call(d, h.formatter, c, a, f, g) : m(c)) : c = m(c),
                            c
                        },
                        o = function(a, b, c, d, e, f) {
                            return b = n(a, b, c, e, "add"),
                            '<td role="gridcell" ' + l(c, d, b, e, a, f) + ">" + b + "</td>"
                        },
                        p = function(a, b, c, e) {
                            return e = '<input role="checkbox" type="checkbox" id="jqg_' + d.p.id + "_" + a + '" class="cbox" name="jqg_' + d.p.id + "_" + a + '"' + (e ? 'checked="checked"': "") + "/>",
                            '<td role="gridcell" ' + l(b, c, "", null, a, !0) + ">" + e + "</td>"
                        },
                        q = function(a, b, c, d) {
                            return c = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b,
                            '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + l(a, b, c, null, b, !0) + ">" + c + "</td>"
                        },
                        r = function(a) {
                            var b, c, e = [],
                            f = 0;
                            for (c = 0; c < d.p.colModel.length; c++) b = d.p.colModel[c],
                            "cb" !== b.name && "subgrid" !== b.name && "rn" !== b.name && (e[f] = "local" === a ? b.name: "xml" === a || "xmlstring" === a ? b.xmlmap || b.name: b.jsonmap || b.name, d.p.keyIndex !== !1 && b.key === !0 && (d.p.keyName = e[f]), f++);
                            return e
                        },
                        s = function(a) {
                            var c = d.p.remapColumns;
                            return c && c.length || (c = b.map(d.p.colModel,
                            function(a, b) {
                                return b
                            })),
                            a && (c = b.map(c,
                        ...
                        t = function(a, c) {
                            var d;
                            this.p.deepempty ? b(this.rows).slice(1).remove() : (d = this.rows.length > 0 ? this.rows[0] : null, b(this.firstChild).empty().append(d)),
                            ...
                            c === !0 && this.p.treeGrid && (this.p.data = [], this.p._index = {})
                        },
                        u = function() {
                            var a, c, e, f = d.p.data.length;
                            for (a = d.p.rownumbers === !0 ? 1 : 0, c = d.p.multiselect === !0 ? 1 : 0, e = d.p.subGrid === !0 ? 1 : 0, a = d.p.keyIndex === !1 || d.p.loadonce === !0 ? d.p.localReader.id: d.p.colModel[d.p.keyIndex + c + e + a].name, c = 0; f > c; c++) e = b.jgrid.getAccessor(d.p.data[c], a),
                            void 0 === e && (e = "" + (c + 1)),
                            d.p._index[e] = c
                        },
                        v = function(a, c, e, f, g, h) {
                            ...
                            if ("object" != typeof h && (h = b.isFunction(d.p.rowattr) ? d.p.rowattr.call(d, f, g, a) : {}), !b.isEmptyObject(h)) {
                                ...
                                h.hasOwnProperty("tabindex") && (j = h.tabindex, delete h.tabindex),
                                h.hasOwnProperty("style") && (c += h.style, delete h.style),
                        ...
                        w = function(a, c, e, f, g) {
                            ...
                            if (i && (d.p.data = [], d.p._index = {},
                            d.p.localReader.id = "_id_"), d.p.reccount = 0, b.isXMLDoc(a)) { - 1 !== d.p.treeANode || d.p.scroll ? e = e > 1 ? e: 1 : (t.call(d, !1, !0), e = 1);
                                ...
                                d.p.subGrid === !0 && (F = 1, w = b.jgrid.getMethod("addSubGridCell")),
                                j.repeatitems || (H = r(l)),
                                x = d.p.keyIndex === !1 ? b.isFunction(j.id) ? j.id.call(d, a) : j.id: d.p.keyIndex,
                                H.length > 0 && !isNaN(x) && (x = d.p.keyName),
                                l = -1 === ("" + x).indexOf("[") ? H.length ?
                                function(a, c) {
                                    return b(x, a).text() || c
                                }: function(a, c) {
                                ...
                                b.isFunction(j.userdata) ? d.p.userData = j.userdata.call(d, a) || {}: b.jgrid.getXmlData(a, j.userdata, !0).each(function() {
                                ...
                                if (L > 0 && d.p.page <= 0 && (d.p.page = 1), a && L) {
                                    ...
                                    for (d.p.grouping && (R = d.p.groupingView.groupCollapse === !0, Q = b.jgrid.getMethod("groupingPrepare")); L > M;) {
                                        ...
                                        } else for (m = 0; m < H.length; m++) u = b.jgrid.getXmlData(z, H[m]),
                                        I[d.p.colModel[m + E + F + G].name] = u,
                                        J.push(o(A, u, m + E + F + G, M + e, z, I));
                                        if (J[S] = v(A, R, B, I, z, !1), J.push("</tr>"), d.p.grouping && (N = Q.call(C, J, N, I, M), J = []), (i || d.p.treeGrid === !0) && (I._id_ = b.jgrid.stripPref(d.p.idPrefix, A), d.p.data.push(I), d.p._index[I._id_] = d.p.data.length - 1), d.p.gridview === !1 && (b("tbody:first", c).append(J.join("")), C.triggerHandler("jqGridAfterInsertRow", [A, I, z]), g && d.p.afterInsertRow.call(d, A, I, z), J = []), I = {},
                                        D++, M++, D === O) break
                                    }
                                }
                        ...
                        x = function(a, c, e, f, g) {
                            var h = new Date;
                            if (a) { - 1 !== d.p.treeANode || d.p.scroll ? e = e > 1 ? e: 1 : (t.call(d, !1, !0), e = 1);
                                var i, j = "local" !== d.p.datatype && d.p.loadonce || "jsonstring" === d.p.datatype;
                                j && (d.p.data = [], d.p._index = {},
                                d.p.localReader.id = "_id_"),
                                d.p.reccount = 0,
                                "local" === d.p.datatype ? (c = d.p.localReader, i = "local") : (c = d.p.jsonReader, i = "json");
                                var l, m, n, u, w = b(d),
                                x = 0,
                                y = [],
                                ...
                                F = d.p.keyIndex === !1 ? b.isFunction(c.id) ? c.id.call(d, a) : c.id: d.p.keyIndex,
                                c.repeatitems || (y = i, y.length > 0 && !isNaN(F) && (F = d.p.keyName)),
                                ...
                                P = !1;
                                g && (N *= g + 1),
                                "local" === d.p.datatype && !d.p.deselectAfterSort && (P = !0);
                                ...
                                for (d.p.grouping && (T = d.p.groupingView.groupCollapse === !0, Q = b.jgrid.getMethod("groupingPrepare")); a > m;) {
                                    ...
                                    void 0 === H && ("number" == typeof F && null != d.p.colModel[F + z + A + B] && (H = b.jgrid.getAccessor(g, d.p.colModel[F + z + A + B].name)), void 0 === H && (H = O + m, 0 === y.length && c.cell && (l = b.jgrid.getAccessor(g, c.cell) || g, H = null != l && void 0 !== l[F] ? l[F] : H))),
                                    H = d.p.idPrefix + H,
                                    l = 1 === e ? 0 : e,
                                    I = (l + m) % 2 === 1 ? L: "",
                                    P && (M = d.p.multiselect ? -1 !== b.inArray(H, d.p.selarrrow) : H === d.p.selrow);
                                    var U = K.length;
                                    for (K.push(""), B && K.push(q(0, m, d.p.page, d.p.rowNum)), z && K.push(p(H, B, m, M)), A && K.push(u.call(w, z + B, m + e)), D = i, c.repeatitems && (c.cell && (g = b.jgrid.getAccessor(g, c.cell) || g), b.isArray(g) && (D = C)), n = 0; n < D.length; n++) l = b.jgrid.getAccessor(g, D[n]),
                                    J[d.p.colModel[n + z + A + B].name] = l,
                                    K.push(o(H, l, n + z + A + B, m + e, g, J));
                                    if (K[U] = v(H, T, I, J, g, M), K.push("</tr>"), d.p.grouping && (S = Q.call(w, K, S, J, m), K = []), (j || d.p.treeGrid === !0) && (J._id_ = b.jgrid.stripPref(d.p.idPrefix, H), d.p.data.push(J), d.p._index[J._id_] = d.p.data.length - 1), d.p.gridview === !1 && (b("#" + b.jgrid.jqID(d.p.id) + " tbody:first").append(K.join("")), w.triggerHandler("jqGridAfterInsertRow", [H, J, g]), R && d.p.afterInsertRow.call(d, H, J, g), K = []), J = {},
                                    x++, m++, x === N) break
                                }
                        ...
                        y = function() {
                            function a(b) {
                                ...
                                if (null != b.rules) try {
                                    for ((e = b.rules.length && "OR" === b.groupOp.toString().toUpperCase()) && q.orBegin(), c = 0; c < b.rules.length; c++) g = b.rules[c],
                                    f = b.groupOp.toString().toUpperCase(),
                                    p[g.op] && g.field && (h > 0 && f && "OR" === f && (q = q.or()), q = p[g.op](q, f)(g.field, g.data, j[g.field])),
                                    h++;
                                    e && q.orEnd()
                                } catch(k) {
                                    alert(k)
                            ...
                            if (b.isArray(d.p.data)) {
                                ...
                                function() {
                                    ...
                                    if (d.p.ignoreCase && (q = q.ignoreCase()), d.p.search === !0) {
                                        ...
                                        if (r)"string" == typeof r && (r = b.jgrid.parse(r)),
                                        a(r);
                                        else try {
                                    ...
                                    r = r.slice((v - 1) * t, v * t),
                                    j = q = null;
                                    return x[d.p.localReader.total] = w,
                        ...
                        B = function(a) {
                            if (!d.grid.hDiv.loading) {
                                ...
                                if (f !== !1 && "stop" !== f) if (b.isFunction(d.p.datatype)) d.p.datatype.call(d, d.p.postData, "load_" + d.p.id, o, a, j);
                                    ...
                                    case "script":
                                        b.ajax(b.extend({
                                            ...
                                            error: function(c, e, f) {
                                                b.isFunction(d.p.loadError) && d.p.loadError.call(d, c, e, f),
                                                1 === a && A()
                                            },
                                            beforeSend: function(a, c) {
                                                var e = !0;
                                                return b.isFunction(d.p.loadBeforeSend) && (e = d.p.loadBeforeSend.call(d, a, c)),
                                                void 0 === e && (e = !0),
                                                e === !1 ? !1 : void z()
                                            }
                                        },
                                    ...
                                    case "xmlstring":
                                        z(),
                                        f = "string" != typeof d.p.datastr ? d.p.datastr: b.parseXML(d.p.datastr),
                                        w(f, d.grid.bDiv),
                                        b(d).triggerHandler("jqGridLoadComplete", [f]),
                                        h && d.p.loadComplete.call(d, f),
                                        b(d).triggerHandler("jqGridAfterLoadComplete", [f]),
                                        d.p.datatype = "local",
                                        d.p.datastr = null,
                                        A();
                                        break;
                                    case "jsonstring":
                                        z(),
                                        f = "string" == typeof d.p.datastr ? b.jgrid.parse(d.p.datastr) : d.p.datastr,
                                        x(f, d.grid.bDiv),
                                        b(d).triggerHandler("jqGridLoadComplete", [f]),
                                        h && d.p.loadComplete.call(d, f),
                                        b(d).triggerHandler("jqGridAfterLoadComplete", [f]),
                        ...
                        C = function(a) {
                            b("#cb_" + b.jgrid.jqID(d.p.id), d.grid.hDiv)[d.p.useProp ? "prop": "attr"]("checked", a),
                            d.p.frozenColumns && b("#cb_" + b.jgrid.jqID(d.p.id), d.grid.fhDiv)[d.p.useProp ? "prop": "attr"]("checked", a)
                        },
                        D = function(a, c) {
                            var e, f, h, i, j = "",
                            ...
                            n = function(a) {
                                var c;
                                return b.isFunction(d.p.onPaging) && (c = d.p.onPaging.call(d, a)),
                                "stop" === c ? !1 : (d.p.selrow = null, d.p.multiselect && (d.p.selarrrow = [], C(!1)), d.p.savedRow = [], !0)
                            },
                            a = a.substr(1),
                            c = c + ("_" + a);
                            ...
                            "rtl" === g && (l += m),
                            d.p.pginput === !0 && (j = "<td dir='" + g + "'>" + b.jgrid.format(d.p.pgtext || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + b.jgrid.jqID(a) + "'></span>") + "</td>"),
                            d.p.pgbuttons === !0 ? (f = ["first" + c, "prev" + c, "next" + c, "last" + c], "rtl" === g && f.reverse(), l += "<td id='" + f[0] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-first'></span></td>", l += "<td id='" + f[1] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-prev'></span></td>", l = l + ("" !== j ? "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>" + j + "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>": "") + ("<td id='" + f[2] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-next'></span></td>"), l += "<td id='" + f[3] + "' class='ui-pg-button ui-corner-all'><span class='ui-icon ui-icon-seek-end'></span></td>") : "" !== j && (l += j),
                            "ltr" === g && (l += m),
                            l += "</tr></tbody></table>",
                            d.p.viewrecords === !0 && b("td#" + a + "_" + d.p.recordpos, "#" + e).append("<div dir='" + g + "' style='text-align:" + d.p.recordpos + "' class='ui-paging-info'></div>"),
                            b("td#" + a + "_" + d.p.pagerpos, "#" + e).append(l),
                            m = b(".ui-jqgrid").css("font-size") || "11px",
                            b(document.body).append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" + m + ";visibility:hidden;' ></div>"),
                            l = b(l).clone().appendTo("#testpg").width(),
                            b("#testpg").remove(),
                            l > 0 && ("" !== j && (l += 50), b("td#" + a + "_" + d.p.pagerpos, "#" + e).width(l)),
                            d.p._nvtd = [],
                            d.p._nvtd[0] = Math.floor(l ? (d.p.width - l) / 2 : d.p.width / 3),
                            d.p._nvtd[1] = 0,
                            l = null,
                            b(".ui-pg-selbox", "#" + e).bind("change",
                            function() {
                            ...
                            function() {
                                ...
                                h = !0,
                                i = !0;
                                return 0 === b || 1 === b ? i = h = g = f = !1 : b > 1 && a >= 1 ? 1 === a ? g = f = !1 : a === b && (i = h = !1) : b > 1 && 0 === a && (i = h = !1, a = b - 1),
                                n(this.id) ? (this.id === "first" + c && f && (d.p.page = 1, e = !0), this.id === "prev" + c && g && (d.p.page = a - 1, e = !0), this.id === "next" + c && h && (d.p.page = a + 1, e = !0), this.id === "last" + c && i && (d.p.page = b, e = !0), e && B(), !1) : !1
                            })),
                        ...
                        E = function(a, c) {
                            ...
                            h[a].lso ? "asc" === h[a].lso ? (h[a].lso = h[a].lso + "-desc", j = "desc") : "desc" === h[a].lso ? (h[a].lso = h[a].lso + "-asc", j = "asc") : ("asc-desc" === h[a].lso || "desc-asc" === h[a].lso) && (h[a].lso = "") : h[a].lso = j = h[a].firstsortorder || "asc",
                            j ? (b("span.s-ico", f).show(), b("span.ui-icon-" + j, f).removeClass("ui-state-disabled"), b(f).attr("aria-selected", "true")) : d.p.viewsortcols[0] || b("span.s-ico", f).hide(),
                            d.p.sortorder = "",
                            b.each(h,
                            function(a) {
                        ...
                        F = function(a, c, e, f, g) {
                            if (d.p.colModel[c].sortable && !(d.p.savedRow.length > 0)) {
                                if (e || (d.p.lastsort === c ? "asc" === d.p.sortorder ? d.p.sortorder = "desc": "desc" === d.p.sortorder && (d.p.sortorder = "asc") : d.p.sortorder = d.p.colModel[c].firstsortorder || "asc", d.p.page = 1), d.p.multiSort) E(c, g);
                                    ...
                                    b("span.ui-icon-" + d.p.sortorder, g).removeClass("ui-state-disabled"),
                                    b(g).attr("aria-selected", "true"),
                                    d.p.viewsortcols[0] || d.p.lastsort === c || (d.p.frozenColumns && d.grid.fhDiv.find("span.s-ico").hide(), b("span.s-ico", e).hide(), b("span.s-ico", g).show()),
                        ...
                        G = function(a) {
                            return a = b(d.grid.headers[a].el),
                            ...
                            a.push(b(d.grid.bDiv).offset().top - b(d.grid.hDiv).offset().top + b(d.grid.bDiv).height()),
                            a
                        },
                        H = function(a) {
                        ...
                        for (this.p.id = this.id, -1 === b.inArray(d.p.multikey, ["shiftKey", "altKey", "ctrlKey"]) && (d.p.multikey = !1), d.p.keyIndex = !1, d.p.keyName = !1, f = 0; f < d.p.colModel.length; f++) d.p.colModel[f] = b.extend(!0, {},
                        d.p.cmTemplate, d.p.colModel[f].template || {},
                        d.p.colModel[f]),
                        !1 === d.p.keyIndex && !0 === d.p.colModel[f].key && (d.p.keyIndex = f);
                        ...
                        if ("horizontal" === d.p.viewsortcols[1] && (R = " ui-i-asc", T = " ui-i-desc"), K = i ? "class='ui-th-div-ie'": "", R = "<span class='s-ico' style='display:none'><span sort='asc' class='ui-grid-ico-sort ui-icon-asc" + R + " ui-state-disabled ui-icon ui-icon-triangle-1-n ui-sort-" + g + "'></span>" + ("<span sort='desc' class='ui-grid-ico-sort ui-icon-desc" + T + " ui-state-disabled ui-icon ui-icon-triangle-1-s ui-sort-" + g + "'></span></span>"), d.p.multiSort) for (U = d.p.sortname.split(","), f = 0; f < U.length; f++) L = b.trim(U[f]).split(" "),
                        U[f] = b.trim(L[0]),
                        V[f] = L[1] ? b.trim(L[1]) : d.p.sortorder || "asc";
                        for (f = 0; f < this.p.colNames.length; f++) L = d.p.headertitles ? ' title="' + b.jgrid.stripHtml(d.p.colNames[f]) + '"': "",
                        S += "<th id='" + d.p.id + "_" + d.p.colModel[f].name + "' role='columnheader' class='ui-state-default ui-th-column ui-th-" + g + "'" + L + ">",
                        L = d.p.colModel[f].index || d.p.colModel[f].name,
                        S += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[f].name + "' " + K + ">" + d.p.colNames[f],
                        d.p.colModel[f].width = d.p.colModel[f].width ? parseInt(d.p.colModel[f].width, 10) : 150,
                        "boolean" != typeof d.p.colModel[f].title && (d.p.colModel[f].title = !0),
                        d.p.colModel[f].lso = "",
                        L === d.p.sortname && (d.p.lastsort = f),
                        d.p.multiSort && (L = b.inArray(L, U), -1 !== L && (d.p.colModel[f].lso = V[L])),
                        S += R + "</div></th>";
                        ...
                        function() {
                            ...
                            var W, X = [];
                            b("#cb_" + b.jgrid.jqID(d.p.id), this).bind("click",
                            function() {
                                d.p.selarrrow = [];
                                ...
                                b(d).triggerHandler("jqGridSelectAll", [W ? d.p.selarrrow: X, W]),
                                b.isFunction(d.p.onSelectAll) && d.p.onSelectAll.call(d, W ? d.p.selarrrow: X, W)
                            })
                        ...
                        function() {
                            ...
                            function() {
                                ...
                                this.hidden === !1 && (h += c + i, this.fixed ? n += c + i: j++)
                            }),
                            isNaN(d.p.width) && (d.p.width = h + (d.p.shrinkToFit !== !1 || isNaN(d.p.height) ? 0 : l)),
                            e.width = d.p.width,
                            d.p.tblwidth = h,
                            d.p.shrinkToFit === !1 && d.p.forceFit === !0 && (d.p.forceFit = !1),
                            d.p.shrinkToFit === !0 && j > 0 && (f = e.width - i * j - n, isNaN(d.p.height) || (f -= l, m = !0), h = 0, b.each(d.p.colModel,
                            function(b) {
                        ...
                        b(j).css("width", e.width + "px").append("<div class='ui-jqgrid-resize-mark' id='rs_m" + d.p.id + "'>&#160;</div>"),
                        ...
                        if (d.p.disableClick = !1, b("th", h).each(function(a) {
                            ...
                            d.p.colModel[a].resizable ? (N = document.createElement("span"), b(N).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + g).css("cursor", "col-resize"), b(this).addClass(d.p.resizeclass)) : N = "",
                            b(this).css("width", M + "px").prepend(N),
                            N = null;
                            var c = "";
                            d.p.colModel[a].hidden && (b(this).css("display", "none"), c = "display:none;"),
                            Z += "<td role='gridcell' style='height:0px;width:" + M + "px;" + c + "'></td>",
                            e.headers[a] = {
                                width: M,
                                el: this
                            },
                            O = d.p.colModel[a].sortable,
                            "boolean" != typeof O && (O = d.p.colModel[a].sortable = !0),
                            c = d.p.colModel[a].name,
                            "cb" === c || "subgrid" === c || "rn" === c || d.p.viewsortcols[2] && b(">div", this).addClass("ui-jqgrid-sortable"),
                            O && (d.p.multiSort ? d.p.viewsortcols[0] ? (b("div span.s-ico", this).show(), d.p.colModel[a].lso && b("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass("ui-state-disabled")) : d.p.colModel[a].lso && (b("div span.s-ico", this).show(), b("div span.ui-icon-" + d.p.colModel[a].lso, this).removeClass("ui-state-disabled")) : d.p.viewsortcols[0] ? (b("div span.s-ico", this).show(), a === d.p.lastsort && b("div span.ui-icon-" + d.p.sortorder, this).removeClass("ui-state-disabled")) : a === d.p.lastsort && (b("div span.s-ico", this).show(), b("div span.ui-icon-" + d.p.sortorder, this).removeClass("ui-state-disabled"))),
                            d.p.footerrow && (Y += "<td role='gridcell' " + l(a, 0, "", null, "", !1) + ">&#160;</td>")
                            ...
                            if (d.p.viewsortcols[2] || (f = "th>div>span>span.ui-grid-ico-sort"), a = b(a.target).closest(f), 1 === a.length) {
                                ...
                                return d.p.viewsortcols[2] || (c = !0, e = a.attr("sort")),
                        ...
                        h = null,
                        _ && b(e.hDiv).hide(),
                        d.p.pager && ("string" == typeof d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + b(d.p.pager).attr("id"), b(d.p.pager).css({
                            width: e.width + "px"
                        }).addClass("ui-state-default ui-jqgrid-pager ui-corner-bottom").appendTo(j), _ && b(d.p.pager).hide(), D(d.p.pager, "")),
                        !1 === d.p.cellEdit && !0 === d.p.hoverrows && b(d).bind("mouseover",
                        function(a) {
                            Q = b(a.target).closest("tr.jqgrow"),
                            "ui-subgrid" !== b(Q).attr("class") && b(Q).addClass("ui-state-hover")
                        }).bind("mouseout",
                        function(a) {
                            Q = b(a.target).closest("tr.jqgrow"),
                            ...
                            if ((e = e === !1 || "stop" === e ? !1 : !0) && b.isFunction(d.p.beforeSelectRow) && (e = d.p.beforeSelectRow.call(d, Q[0].id, a)), "A" !== P.tagName && ("INPUT" !== P.tagName && "TEXTAREA" !== P.tagName && "OPTION" !== P.tagName && "SELECT" !== P.tagName || c) && e === !0) if (ab = Q[0].id, bb = b.jgrid.getCellIndex(P), cb = b(P).closest("td,th").html(), b(d).triggerHandler("jqGridCellSelect", [ab, bb, cb, a]), b.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, ab, bb, cb, a), d.p.cellEdit === !0) if (d.p.multiselect && c) b(d).jqGrid("setSelection", ab, !0, a);
                                ...
                                if (d.p.multiselect && d.p.multiboxonly && !c) {
                                    ...
                                    b(d.p.selarrrow).each(function(a, c) {
                                        ...
                                        b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + b.jgrid.jqID(c))[d.p.useProp ? "prop": "attr"]("checked", !1),
                                        g && (b("#" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(g)).removeClass("ui-state-highlight"), b("#jqg_" + b.jgrid.jqID(d.p.id) + "_" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(g))[d.p.useProp ? "prop": "attr"]("checked", !1))
                                    }),
                                    d.p.selarrrow = []
                                }
                        ...
                        function(a, c) {
                            ...
                            return d.grid.prevRowHeight && d.p.scroll ? (delete d.p.lastpage, d.grid.populateVisible()) : d.grid.populate(),
                            d.p._inlinenav === !0 && b(d).jqGrid("showAddEditButtons"),
                            !1
                        }).dblclick(function(a) {
                            P = a.target,
                            Q = b(P, d.rows).closest("tr.jqgrow"),
                            0 !== b(Q).length && (ab = Q[0].rowIndex, bb = b.jgrid.getCellIndex(P), b(d).triggerHandler("jqGridDblClickRow", [b(Q).attr("id"), ab, bb, a]), b.isFunction(d.p.ondblClickRow) && d.p.ondblClickRow.call(d, b(Q).attr("id"), ab, bb, a))
                        }).bind("contextmenu",
                        function(a) {
                            P = a.target,
                            Q = b(P, d.rows).closest("tr.jqgrow"),
                            0 !== b(Q).length && (d.p.multiselect || b(d).jqGrid("setSelection", Q[0].id, !0, a), ab = Q[0].rowIndex, bb = b.jgrid.getCellIndex(P), b(d).triggerHandler("jqGridRightClickRow", [b(Q).attr("id"), ab, bb, a]), b.isFunction(d.p.onRightClickRow) && d.p.onRightClickRow.call(d, b(Q).attr("id"), ab, bb, a))
                        }),
                        e.bDiv = document.createElement("div"),
                        i && "auto" === ("" + d.p.height).toLowerCase() && (d.p.height = "100%"),
                        b(e.bDiv).append(b('<div style="position:relative;' + (i && 8 > b.jgrid.msiever() ? "height:0.01%;": "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                        ...
                        d.p.multikey && (b.jgrid.msie ? b(e.bDiv).bind("selectstart",
                        function() {
                            return ! 1
                        ...
                        b(document).bind("mouseup.jqGrid" + d.p.id,
                        function() {
                        ...
                        d.updatepager = function(a, c) {
                            ...
                            i = g + d.p.reccount,
                            d.p.scroll && (e = b("tbody:first > tr:gt(0)", d.grid.bDiv), g = i - e.length, d.p.reccount = e.length, (e = e.outerHeight() || d.grid.prevRowHeight) && (f = g * e, l = parseInt(d.p.records, 10) * e, b(">div:first", d.grid.bDiv).css({
                                height: l
                            }).children("div:first").css({
                                height: f,
                                display: f ? "": "none"
                            }), 0 == d.grid.bDiv.scrollTop && d.p.page > 1 && (d.grid.bDiv.scrollTop = d.p.rowNum * (d.p.page - 1) * e)), d.grid.bDiv.scrollLeft = d.grid.hDiv.scrollLeft),
                            m = d.p.pager || "",
                            (m += d.p.toppager ? m ? "," + d.p.toppager: d.p.toppager: "") && (l = b.jgrid.formatter.integer || {},
                            e = k(d.p.page), f = k(d.p.lastpage), b(".selbox", m)[this.p.useProp ? "prop": "attr"]("disabled", !1), d.p.pginput === !0 && (b(".ui-pg-input", m).val(d.p.page), h = d.p.toppager ? "#sp_1" + n + ",#sp_1" + o: "#sp_1" + n, b(h).html(b.fmatter ? b.fmatter.util.NumberFormat(d.p.lastpage, l) : d.p.lastpage)), d.p.viewrecords && (0 === d.p.reccount ? b(".ui-paging-info", m).html(d.p.emptyrecords) : (h = g + 1, j = d.p.records, b.fmatter && (h = b.fmatter.util.NumberFormat(h, l), i = b.fmatter.util.NumberFormat(i, l), j = b.fmatter.util.NumberFormat(j, l)), b(".ui-paging-info", m).html(b.jgrid.format(d.p.recordtext, h, i, j)))), d.p.pgbuttons === !0 && (0 >= e && (e = f = 0), 1 === e || 0 === e ? (b("#first" + n + ", #prev" + n).addClass("ui-state-disabled").removeClass("ui-state-hover"), d.p.toppager && b("#first_t" + o + ", #prev_t" + o).addClass("ui-state-disabled").removeClass("ui-state-hover")) : (b("#first" + n + ", #prev" + n).removeClass("ui-state-disabled"), d.p.toppager && b("#first_t" + o + ", #prev_t" + o).removeClass("ui-state-disabled")), e === f || 0 === e ? (b("#next" + n + ", #last" + n).addClass("ui-state-disabled").removeClass("ui-state-hover"), d.p.toppager && b("#next_t" + o + ", #last_t" + o).addClass("ui-state-disabled").removeClass("ui-state-hover")) : (b("#next" + n + ", #last" + n).removeClass("ui-state-disabled"), d.p.toppager && b("#next_t" + o + ", #last_t" + o).removeClass("ui-state-disabled")))),
                            a === !0 && d.p.rownumbers === !0 && b(">td.jqgrid-rownum", d.rows).each(function(a) {
                                b(this).html(g + 1 + a)
                            }),
    ...
    b.jgrid.extend({
        ...
        getDataIDs: function() {
            ...
            e = 0;
            return this.each(function() {
                if ((a = this.rows.length) && a > 0) for (; a > d;) b(this.rows[d]).hasClass("jqgrow") && (c[e] = this.rows[d].id, e++),
                d++
            }),
            c
        },
        ...
        resetSelection: function(a) {
            return this.each(function() {
                var c, d, e = this; ! 0 === e.p.frozenColumns && (d = e.p.id + "_frozen"),
                void 0 !== a ? (c = a === e.p.selrow ? e.p.selrow: a, b("#" + b.jgrid.jqID(e.p.id) + " tbody:first tr#" + b.jgrid.jqID(c)).removeClass("ui-state-highlight").attr("aria-selected", "false"), d && b("#" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(d)).removeClass("ui-state-highlight"), e.p.multiselect && (b("#jqg_" + b.jgrid.jqID(e.p.id) + "_" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(e.p.id))[e.p.useProp ? "prop": "attr"]("checked", !1), d && b("#jqg_" + b.jgrid.jqID(e.p.id) + "_" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(d))[e.p.useProp ? "prop": "attr"]("checked", !1), e.setHeadCheckBox(!1)), c = null) : e.p.multiselect ? (b(e.p.selarrrow).each(function(a, c) {
                    b(b(e).jqGrid("getGridRowById", c)).removeClass("ui-state-highlight").attr("aria-selected", "false"),
                    b("#jqg_" + b.jgrid.jqID(e.p.id) + "_" + b.jgrid.jqID(c))[e.p.useProp ? "prop": "attr"]("checked", !1),
                    d && (b("#" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(d)).removeClass("ui-state-highlight"), b("#jqg_" + b.jgrid.jqID(e.p.id) + "_" + b.jgrid.jqID(c), "#" + b.jgrid.jqID(d))[e.p.useProp ? "prop": "attr"]("checked", !1))
                }), e.setHeadCheckBox(!1), e.p.selarrrow = []) : e.p.selrow && (b("#" + b.jgrid.jqID(e.p.id) + " tbody:first tr#" + b.jgrid.jqID(e.p.selrow)).removeClass("ui-state-highlight").attr("aria-selected", "false"), d && b("#" + b.jgrid.jqID(e.p.selrow), "#" + b.jgrid.jqID(d)).removeClass("ui-state-highlight"), e.p.selrow = null),
        ...
        addRowData: function(a, c, d, e) {
            ...
            return c && (b.isArray(c) ? (n = !0, d = "last", o = a) : (c = [c], n = !1), this.each(function() {
                ...
                z = b.isFunction(this.p.afterInsertRow) ? !0 : !1; v > w;) {
                    ...
                    w++,
                    "local" === this.p.datatype && (y[this.p.localReader.id] = s, this.p._index[s] = this.p.data.length, this.p.data.push(y), y = {})
                }
        ...
        footerData: function(a, c, d) {
            ...
            this.each(function() {
                ...
                return ! k.grid || !k.p.footerrow || "set" === a && e(c) ? !1 : (h = !0, void b(this.p.colModel).each(function(e) {
                    f = this.name,
                    "set" === a ? void 0 !== c[f] && (j = d ? k.formatter("", c[f], e, c, "edit") : c[f], g = this.title ? {
                ...
                if (e.grid) {
                    ...
                    b(this.p.colModel).each(function(i) {
                        if ( - 1 !== b.inArray(this.name, a) && this.hidden === h) {
                            ...
                            e.p.footerrow && b("tr.footrow td:eq(" + i + ")", e.grid.sDiv).css("display", c),
                            d = parseInt(this.width, 10),
                            e.p.tblwidth = "none" === c ? e.p.tblwidth - (d + g) : e.p.tblwidth + (d + g),
                            this.hidden = !h,
                            f = !0,
                            b(e).triggerHandler("jqGridShowHideCol", [h, this.name, i])
                        }
                    }),
                    !0 === f && (!0 === e.p.shrinkToFit && !isNaN(e.p.height) && (e.p.tblwidth += parseInt(e.p.scrollOffset, 10)), b(e).jqGrid("setGridWidth", !0 === e.p.shrinkToFit ? e.p.tblwidth: e.p.width)),
        ...
        remapColumns: function(a, c, d) {
            function e(c) {
                var d;
                d = c.length ? b.makeArray(c) : b.extend({},
                c),
                b.each(a,
                function(a) {
                    c[a] = d[this]
            ...
            c && f(b("#" + b.jgrid.jqID(g.p.id) + " tbody:first"), ".jqgfirstrow, tr.jqgrow, tr.jqfoot"),
            g.p.footerrow && f(b("tbody:first", g.grid.sDiv)),
            g.p.remapColumns && (g.p.remapColumns.length ? e(g.p.remapColumns) : g.p.remapColumns = b.makeArray(a)),
                ...
                if (this.grid) {
                    ...
                    if ("boolean" != typeof c && (c = h.p.shrinkToFit), !isNaN(a)) {
                        if (a = parseInt(a, 10), h.grid.width = h.p.width = a, b("#gbox_" + b.jgrid.jqID(h.p.id)).css("width", a + "px"), b("#gview_" + b.jgrid.jqID(h.p.id)).css("width", a + "px"), b(h.grid.bDiv).css("width", a + "px"), b(h.grid.hDiv).css("width", a + "px"), h.p.pager && b(h.p.pager).css("width", a + "px"), h.p.toppager && b(h.p.toppager).css("width", a + "px"), !0 === h.p.toolbar[0] && (b(h.grid.uDiv).css("width", a + "px"), "both" === h.p.toolbar[1] && b(h.grid.ubDiv).css("width", a + "px")), h.p.footerrow && b(h.grid.sDiv).css("width", a + "px"), !1 === c && !0 === h.p.forceFit && (h.p.forceFit = !1), !0 === c) {
                            if (b.each(h.p.colModel,
                            function() {
                                this.hidden === !1 && (d = this.widthOrg, i += d + j, this.fixed ? n += d + j: k++)
                            }), 0 === k) return;
                            h.p.tblwidth = i,
                            f = a - j * k - n,
                            !isNaN(h.p.height) && (b(h.grid.bDiv)[0].clientHeight < b(h.grid.bDiv)[0].scrollHeight || 1 === h.rows.length) && (l = !0, f -= m);
                            var i = 0,
                            ...
                            g = 0,
                            l ? a - n - (i + j * k) !== m && (g = a - n - (i + j * k) - m) : 1 !== Math.abs(a - n - (i + j * k)) && (g = a - n - (i + j * k)),
                            h.p.colModel[e].width += g,
                            h.p.tblwidth = i + g + j * k + n,
                            h.p.tblwidth > a ? (l = h.p.tblwidth - parseInt(a, 10), h.p.tblwidth = a, d = h.p.colModel[e].width -= l) : d = h.p.colModel[e].width,
        ...
        setGridHeight: function(a) {
            return this.each(function() {
                if (this.grid) {
                    ...
                    !0 === this.p.frozenColumns && b("#" + b.jgrid.jqID(this.p.id) + "_frozen").parent().height(c.height() - 16),
                    this.p.height = a,
        ...
        setCaption: function(a) {
            return this.each(function() {
                this.p.caption = a,
                b("span.ui-jqgrid-title, span.ui-jqgrid-title-rtl", this.grid.cDiv).html(a),
        ...
        setCell: function(a, c, d, e, f, g) {
            return this.each(function() {
                ...
                if (this.grid && (isNaN(c) ? b(this.p.colModel).each(function(a) {
                    ...
                    var k = b("td:eq(" + j + ")", h); ("" !== d || !0 === g) && (h = this.formatter(a, d, j, h, "edit"), i = this.p.colModel[j].title ? {
                        title: b.jgrid.stripHtml(h)
                    }: {},
                    this.p.treeGrid && 0 < b(".tree-wrap", b(k)).length ? b("span", b(k)).html(h).attr(i) : b(k).html(h).attr(i), "local" === this.p.datatype && (h = this.p.colModel[j], d = h.formatter && "string" == typeof h.formatter && "date" === h.formatter ? b.unformat.date.call(this, d, h) : d, i = this.p._index[b.jgrid.stripPref(this.p.idPrefix, a)], void 0 !== i && (this.p.data[i][h.name] = d))),
        ...
        clearGridData: function(a) {
            return this.each(function() {
                if (this.grid) {
                    ...
                    this.p.footerrow && a && b(".ui-jqgrid-ftable td", this.grid.sDiv).html("&#160;"),
                    this.p.selrow = null,
                    this.p.selarrrow = [],
                    this.p.savedRow = [],
                    this.p.records = 0,
        ...
        getInd: function(a, c) {
            var d, e = !1;
            return this.each(function() { (d = b(this).jqGrid("getGridRowById", a)) && (e = !0 === c ? d: d.rowIndex)
            }),
            e
        },
        bindKeys: function(a) {
            ...
            return this.each(function() {
                ...
                b(a).keydown(function(d) {
                    ...
                    if (h) if (g = a.p._index[b.jgrid.stripPref(a.p.idPrefix, h.id)], 37 === d.keyCode || 38 === d.keyCode || 39 === d.keyCode || 40 === d.keyCode) {
                        ...
                        37 === d.keyCode && (a.p.treeGrid && a.p.data[g][i] && b(h).find("div.treeclick").trigger("click"), b(a).triggerHandler("jqGridKeyLeft", [a.p.selrow]), b.isFunction(c.onLeftKey) && c.onLeftKey.call(a, a.p.selrow)),
                        39 === d.keyCode && (a.p.treeGrid && !a.p.data[g][i] && b(h).find("div.treeclick").trigger("click"), b(a).triggerHandler("jqGridKeyRight", [a.p.selrow]), b.isFunction(c.onRightKey) && c.onRightKey.call(a, a.p.selrow))
...
function(a) {
    ...
    a.fn.fmatter.checkbox = function(b, c) {
        ...
        b = ("" + b).toLowerCase(),
        '<input type="checkbox" ' + (0 > b.search(/(false|f|0|no|n|off|undefined)/i) ? " checked='checked' ": "") + ' value="' + b + '" offval="no" ' + d + "/>"
    },
    ...
    a.fn.fmatter.showlink = function(b, c) {
        ...
        a.fmatter.isString(b) || a.fmatter.isNumber(b) ? "<a " + e + ' href="' + d + '">' + b + "</a>": a.fn.fmatter.defaultFormat(b, c)
    },
    ...
    a.fn.fmatter.date = function(b, c, d, e) {
        return d = a.extend({},
        c.date),
        void 0 !== c.colModel && void 0 !== c.colModel.formatoptions && (d = a.extend({},
        d, c.colModel.formatoptions)),
        d.reformatAfterEdit || "edit" !== e ? a.fmatter.isEmpty(b) ? a.fn.fmatter.defaultFormat(b, c) : a.jgrid.parseDate(d.srcformat, b, d.newformat, d) : a.fn.fmatter.defaultFormat(b, c)
    },
    a.fn.fmatter.select = function(b, c) {
        ...
        if (void 0 !== c.colModel.formatoptions ? (f = c.colModel.formatoptions.value, d = void 0 === c.colModel.formatoptions.separator ? ":": c.colModel.formatoptions.separator, e = void 0 === c.colModel.formatoptions.delimiter ? ";": c.colModel.formatoptions.delimiter) : void 0 !== c.colModel.editoptions && (f = c.colModel.editoptions.value, d = void 0 === c.colModel.editoptions.separator ? ":": c.colModel.editoptions.separator, e = void 0 === c.colModel.editoptions.delimiter ? ";": c.colModel.editoptions.delimiter), f) {
            ...
            i = [];
            if (h && (i = b.split(","), i = a.map(i,
            function(b) {
                return a.trim(b)
            })), a.fmatter.isString(f)) {
                var j, k = f.split(e),
                l = 0;
                for (j = 0; j < k.length; j++) if (e = k[j].split(d), 2 < e.length && (e[1] = a.map(e,
                function(a, b) {
                    return b > 0 ? a: void 0
            ...
            } else a.fmatter.isObject(f) && (h ? g = a.map(i,
            function(a) {
                return f[a]
            }) : g[0] = f[b] || "")
        }
    ...
    a.fn.fmatter.actions = function(b, c) {
        ...
        e = c.rowId,
        f = "";
        return void 0 !== c.colModel.formatoptions && (d = a.extend(d, c.colModel.formatoptions)),
    ...
    a.unformat = function(b, c, d, e) {
        ...
        case "number":
            ...
            f.number, h),
            c = h.thousandsSeparator.replace(i, "\\$1"),
            f = a(b).text().replace(RegExp(c, "g"), "").replace(h.decimalSeparator, ".");
            break;
        case "currency":
            h = a.extend({},
            f.currency, h),
    ...
    a.unformat.select = function(b, c, d, e) {
        ...
        if (e.value) {
            ...
            e = !0 === e.multiple ? !0 : !1,
            h = [];
            if (e && (h = b.split(","), h = a.map(h,
            function(b) {
                return a.trim(b)
            })), a.fmatter.isString(g)) {
                var i, j = g.split(f),
                k = 0;
                for (i = 0; i < j.length; i++) if (f = j[i].split(c), 2 < f.length && (f[1] = a.map(f,
                function(a, b) {
                    return b > 0 ? a: void 0
            ...
            } else(a.fmatter.isObject(g) || a.isArray(g)) && (e || (h[0] = b), d = a.map(h,
            function(b) {
                var c;
                return a.each(g,
                function(a, d) {
    ...
    a.jgrid.extend({
            ...
            return this.each(function() {
                ...
                if (this.grid) {
                    for (a || (a = this.p.sortname), d = 0; d < this.p.colModel.length; d++) if (this.p.colModel[d].index === a || this.p.colModel[d].name === a) {
                        e = d,
                        !0 === this.p.frozenColumns && !0 === this.p.colModel[d].frozen && (f = this.grid.fhDiv.find("#" + this.p.id + "_" + a));
                        break
            ...
            this.each(function() {
                ...
                if (!this.ftoolbar) {
                    ...
                    f = function(d, f, g) {
                        ...
                        for (k = c.p.colModel[k], l = a.extend({},
                        k.searchoptions), l.sopt || (l.sopt = [], l.sopt[0] = "select" === k.stype ? "eq": b.defaultSearch), a.each(b.odata,
                        function() {
                            j.push(this.oper)
                        }), k = 0; k < l.sopt.length; k++) i = a.inArray(l.sopt[k], j),
                        -1 !== i && (h = g === b.odata[i].oper ? "ui-state-highlight": "", f += '<li class="ui-menu-item ' + h + '" role="presentation"><a class="ui-corner-all g-menu-item" tabindex="0" role="menuitem" value="' + b.odata[i].oper + '" oper="' + b.operands[b.odata[i].oper] + '"><table cellspacing="0" cellpadding="0" border="0"><tr><td width="25px">' + b.operands[b.odata[i].oper] + "</td><td>" + b.odata[i].text + "</td></tr></table></a></li>");
                        a("body").append(f + "</ul>"),
                        ...
                        function() {
                            ...
                            g = a(this).attr("oper");
                            a(c).triggerHandler("jqGridToolbarSelectOper", [f, g, d]),
                            a("#sopt_menu").hide(),
                            a(d).text(g).attr("soper", f),
                            b.autosearch === !0 && (g = a(d).parent().next().children()[0], (a(g).val() || "nu" === f || "nn" === f) && e())
                        })
                    },
                    ...
                    function(f) {
                        ...
                        if (!0 === this.hidden && a(m).css("display", "none"), this.search = !1 === this.search ? !1 : !0, void 0 === this.stype && (this.stype = "text"), h = a.extend({},
                        this.searchoptions || {}), this.search) {
                            ...
                            case "select":
                                if (i = this.surl || h.dataUrl) a(n).append(o),
                                a.ajax(a.extend({
                                    url: i,
                                    dataType: "html",
                                    success: function(d) {
                                        void 0 !== h.buildSelect ? (d = h.buildSelect(d)) && a("td:eq(1)", o).append(d) : a("td:eq(1)", o).append(d),
                                        void 0 !== h.defaultValue && a("select", n).val(h.defaultValue),
                                        a("select", n).attr({
                                            name: j.index || j.name,
                                            id: "gs_" + j.name
                                        }),
                                        ...
                                        a.jgrid.bindEv.call(c, a("select", n)[0], h),
                                        b.autosearch === !0 && a("select", n).change(function() {
                                            return e(),
                                            !1
                                        }),
                                        d = null
                                ...
                                a.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {}));
                                    ...
                                    if (j.searchoptions ? (p = void 0 === j.searchoptions.value ? "": j.searchoptions.value, q = void 0 === j.searchoptions.separator ? ":": j.searchoptions.separator, r = void 0 === j.searchoptions.delimiter ? ";": j.searchoptions.delimiter) : j.editoptions && (p = void 0 === j.editoptions.value ? "": j.editoptions.value, q = void 0 === j.editoptions.separator ? ":": j.editoptions.separator, r = void 0 === j.editoptions.delimiter ? ";": j.editoptions.delimiter), p) {
                                        ...
                                        var s;
                                        if ("string" == typeof p) for (i = p.split(r), s = 0; s < i.length; s++) p = i[s].split(q),
                                        ...
                                        !0 === b.autosearch && a(f).change(function() {
                                            return e(),
                                            !1
                                        })
                                    }
                            ...
                            case "text":
                                ...
                                a("td:eq(1)", o).append("<input type='text' style='width:100%;padding:0px;' name='" + (j.index || j.name) + "' id='gs_" + j.name + "' value='" + q + "'/>"),
                                a(n).append(o),
                                ...
                                break;
                            case "custom":
                                a("td:eq(1)", o).append("<span style='width:95%;padding:0px;' name='" + (j.index || j.name) + "' id='gs_" + j.name + "'/>"),
                                a(n).append(o);
                                try {
                                    ...
                                    "e1" === u && a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose),
                                    "e2" === u ? a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.novalue, a.jgrid.edit.bClose) : a.jgrid.info_dialog(a.jgrid.errors.errcap, "string" == typeof u ? u: u.message, a.jgrid.edit.bClose)
                                }
                            }
                        }
                        a(m).append(n),
                    ...
                    a(".clearsearchclass", g).click(function() {
                        ...
                        "select" === c.p.colModel[f].stype ? g ? a("td.ui-search-input select", d).val(g) : a("td.ui-search-input select", d)[0].selectedIndex = 0 : a("td.ui-search-input input", d).val(g),
                        b.autosearch === !0 && e()
                    }),
                    this.ftoolbar = !0,
        ...
        setGroupHeaders: function(b) {
            ...
            this.each(function() {
                ...
                e.insertAfter(o),
                n.append(k),
                b.useColSpanStyle && (n.find("span.ui-jqgrid-resize").each(function() {
                    var b = a(this).parent();
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (! (!0 === b.p.subGrid || !0 === b.p.treeGrid || !0 === b.p.cellEdit || b.p.sortable || b.p.scroll || b.p.grouping)) {
                        for (b.p.rownumbers && d++, b.p.multiselect && d++; e > d && !0 === c[d].frozen;) g = !0,
                        f = d,
                        d++;
                        if (f >= 0 && g) {
                            if (c = b.p.caption ? a(b.grid.cDiv).outerHeight() : 0, d = a(".ui-jqgrid-htable", "#gview_" + a.jgrid.jqID(b.p.id)).height(), b.p.toppager && (c += a(b.grid.topDiv).outerHeight()), !0 === b.p.toolbar[0] && "bottom" !== b.p.toolbar[1] && (c += a(b.grid.uDiv).outerHeight()), b.grid.fhDiv = a('<div style="position:absolute;left:0px;top:' + c + "px;height:" + d + 'px;" class="frozen-div ui-state-default ui-jqgrid-hdiv"></div>'), b.grid.fbDiv = a('<div style="position:absolute;left:0px;top:' + (parseInt(c, 10) + parseInt(d, 10) + 1) + 'px;overflow-y:hidden" class="frozen-bdiv ui-jqgrid-bdiv"></div>'), a("#gview_" + a.jgrid.jqID(b.p.id)).append(b.grid.fhDiv), c = a(".ui-jqgrid-htable", "#gview_" + a.jgrid.jqID(b.p.id)).clone(!0), b.p.groupHeader) {
                                ...
                                a("tr.jqg-second-row-header th", c).each(function() {
                                    return h = parseInt(a(this).attr("colspan"), 10),
...
function(a) {
    a.extend(a.jgrid, {
        ...
        createModal: function(b, c, d, e, f, g, h) {
            ...
            if (a(n).addClass("ui-jqdialog-content ui-widget-content").attr("id", b.modalcontent), a(n).append(c), j.appendChild(n), a(j).prepend(l), !0 === g ? a("body").append(j) : "string" == typeof g ? a(g).append(j) : a(j).insertBefore(e), a(j).css(h), void 0 === d.jqModal && (d.jqModal = !0), c = {},
            a.fn.jqm && !0 === d.jqModal ? (0 === d.left && 0 === d.top && d.overlay && (h = [], h = a.jgrid.findPos(f), d.left = h[0] + 4, d.top = h[1] + 4), c.top = d.top + "px", c.left = d.left) : (0 !== d.left || 0 !== d.top) && (c.left = d.left, c.top = d.top + "px"), a("a.ui-jqdialog-titlebar-close", l).click(function() {
        ...
        info_dialog: function(b, c, d, e) {
            ...
            var g = f.jqModal,
            h = this;
            if (a.fn.jqm && !g && (g = !1), b = "", 0 < f.buttons.length) for (e = 0; e < f.buttons.length; e++) void 0 === f.buttons[e].id && (f.buttons[e].id = "info_button_" + e),
            b += "<a id='" + f.buttons[e].id + "' class='fm-button ui-state-default ui-corner-all'>" + f.buttons[e].text + "</a>";
            e = isNaN(f.dataheight) ? f.dataheight: f.dataheight + "px",
            c = "<div id='info_id'>" + ("<div id='infocnt' style='margin:0px;padding-bottom:1em;width:100%;overflow:auto;position:relative;height:" + e + ";" + ("text-align:" + f.align + ";") + "'>" + c + "</div>"),
            c += d ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:" + f.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'><a id='closedialog' class='fm-button ui-state-default ui-corner-all'>" + d + "</a>" + b + "</div>": "" !== b ? "<div class='ui-widget-content ui-helper-clearfix' style='text-align:" + f.buttonalign + ";padding-bottom:0.8em;padding-top:0.5em;background-image: none;border-width: 1px 0 0 0;'>" + b + "</div>": "",
            c += "</div>";
            try {
        ...
        createEl: function(b, c, d, e, f) {
            ...
            case "checkbox":
                ...
                h.type = "checkbox",
                c.value ? (b = c.value.split(":"), d === b[0] && (h.checked = !0, h.defaultChecked = !0), h.value = b[0], a(h).attr("offval", b[1])) : (b = (d + "").toLowerCase(), 0 > b.search(/(false|f|0|no|n|off|undefined)/i) && "" !== b ? (h.checked = !0, h.defaultChecked = !0, h.value = d) : h.value = "on", a(h).attr("offval", "off")),
                g(h, c, ["value"]),
                ...
                if (h = document.createElement("select"), h.setAttribute("role", "select"), e = [], !0 === c.multiple ? (b = !0, h.multiple = "multiple", a(h).attr("aria-multiselectable", "true")) : b = !1, void 0 !== c.dataUrl) {
                    ...
                    a.ajax(a.extend({
                        ...
                        success: function(b) {
                            ...
                            b && (a(d).append(b), g(d, f, j ? ["postData"] : void 0), void 0 === f.size && (f.size = h ? 3 : 1), h ? (c = e.split(","), c = a.map(c,
                            function(b) {
                                return a.trim(b)
                    ...
                    if ("string" == typeof c.value) for (l = c.value.split(f), k = 0; k < l.length; k++) m = l[k].split(n),
                    2 < m.length && (m[1] = a.map(m,
                    function(a, b) {
                        return b > 0 ? a: void 0
                    }).join(n)),
                    ...
                    f.innerHTML = m[1],
                    h.appendChild(f),
                    b || a.trim(m[0]) !== a.trim(d) && a.trim(m[1]) !== a.trim(d) || (f.selected = "selected"),
                    b && ( - 1 < a.inArray(a.trim(m[1]), e) || -1 < a.inArray(a.trim(m[0]), e)) && (f.selected = "selected");
            ...
            case "custom":
                ...
                try {
                    ...
                    "e1" === o && a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose),
                    "e2" === o ? a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_element' " + a.jgrid.edit.msg.novalue, a.jgrid.edit.bClose) : a.jgrid.info_dialog(a.jgrid.errors.errcap, "string" == typeof o ? o: o.message, a.jgrid.edit.bClose)
                }
            }
            return h
        },
        checkDate: function(a, b) {
            ...
            var e, f, g = -1,
            h = -1;
            for (f = 0; f < a.length; f++) e = isNaN(b[f]) ? 0 : parseInt(b[f], 10),
            d[a[f]] = e,
            e = a[f],
            -1 !== e.indexOf("y") && (c = f),
            -1 !== e.indexOf("m") && (h = f),
...
function(a) {
    ...
    a.jgrid.extend({
        searchGrid: function(b) {
            ...
            this.each(function() {
                function c(c) {
                    ...
                    f && (a.jgrid.viewModal("#" + a.jgrid.jqID(h.themodal), {
                ...
                if (d.grid) {
                    ...
                    if ("string" == typeof i && (i = a.jgrid.parse(i)), !0 === b.recreateFilter && a("#" + a.jgrid.jqID(h.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(h.themodal))[0]) c(a("#fbox_" + a.jgrid.jqID( + d.p.id)));
                        ...
                        s = !1,
                        t = -1;
                        if (b.showQuery && (q = "<a id='" + e + "_query' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'><span class='ui-icon ui-icon-comment'></span>Query</a>"), b.columns.length ? (n = b.columns, t = 0, m = n[0].index || n[0].name) : a.each(n,
                        function(a, b) {
                            if (b.label || (b.label = d.p.colNames[a]), !s) {
                                var c = void 0 === b.search ? !0 : b.search,
                                e = b.hidden === !0; (b.searchoptions && b.searchoptions.searchhidden === !0 && c || c && !e) && (s = !0, m = b.index || b.name, t = a)
                            }
                        ...
                        k = "<table class='EditTable' style='border:0px none;margin-top:5px' id='" + e + "_2'><tbody><tr><td colspan='2'><hr class='ui-widget-content' style='margin:1px'/></td></tr><tr><td class='EditButton' style='text-align:" + k + "'>" + p + r + "</td><td class='EditButton' " + l + ">" + q + o + "</td></tr></tbody></table>",
                        e = a.jgrid.jqID(e),
                        a("#" + e).jqFilter({
                            columns: n,
                        ...
                        j.append(k),
                        s && b.tmplFilters && b.tmplFilters.length && a(".ui-template", j).bind("change",
                        function() {
                            var c = a(this).val();
                            return "default" === c ? a("#" + e).jqFilter("addFilter", i) : a("#" + e).jqFilter("addFilter", b.tmplFilters[parseInt(c, 10)]),
                            !1
                        }),
                        ...
                        b.gbox = "#gbox_" + e,
                        b.layer ? a.jgrid.createModal(h, j, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0], "#" + a.jgrid.jqID(b.layer), {
                            position: "relative"
                        }) : a.jgrid.createModal(h, j, b, "#gview_" + a.jgrid.jqID(d.p.id), a("#gbox_" + a.jgrid.jqID(d.p.id))[0]),
                        (b.searchOnEnter || b.closeOnEscape) && a("#" + a.jgrid.jqID(h.themodal)).keydown(function(c) {
                            var d = a(c.target);
                        ...
                        function() {
                            ...
                            if (b.stringResult) {
                                ...
                                "string" == typeof c && (i[b.sFilter] = c, a.each([b.sField, b.sValue, b.sOper],
                                function() {
                                    i[this] = ""
                                }))
                            } else b.multipleSearch ? (i[b.sFilter] = j, a.each([b.sField, b.sValue, b.sOper],
                            function() {
                                i[this] = ""
                            ...
                            void 0 === g && (g = !0),
                            g && a.isFunction(b.onSearch) && (g = b.onSearch.call(d, d.p.filters)),
                            g !== !1 && a(d).trigger("reloadGrid", [{
                                page: 1
                            }]),
        ...
        editGridRow: function(c, d) {
            ...
            this.each(function() {
                ...
                function f(c, d, e, f) {
                    ...
                    return "_empty" !== c && (q = a(d).jqGrid("getInd", c)),
                    a(d.p.colModel).each(function(m) {
                        if (g = this.name, k = (h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'": "", "cb" !== g && "subgrid" !== g && !0 === this.editable && "rn" !== g) {
                            ...
                            a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), (b[o.p.id].checkOnSubmit || b[o.p.id].checkOnUpdate) && (b[o.p.id]._savedData[g] = j), a(l).addClass("FormElement"), -1 < a.inArray(this.edittype, ["text", "textarea", "password", "select"]) && a(l).addClass("ui-widget-content ui-corner-all"), i = a(e).find("tr[rowpos=" + w + "]"), v.rowabove) {
                                var y = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + v.rowcontent + "</td></tr>");
                                a(e).append(y),
                                y[0].rp = w
                            }
                            0 === i.length && (i = a("<tr " + k + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + g), a(i).append(r), a(e).append(i), i[0].rp = w),
                            a("td:eq(" + (x - 2) + ")", i[0]).html(void 0 === v.label ? d.p.colNames[m] : v.label),
                            a("td:eq(" + (x - 1) + ")", i[0]).append(v.elmprefix).append(l).append(v.elmsuffix),
                            "custom" === this.edittype && a.isFunction(u.custom_value) && u.custom_value.call(o, a("#" + g, "#" + t), "set", j),
                            a.jgrid.bindEv.call(o, l, u),
                            p[n] = m,
                            n++
                        }
                    }),
                    n > 0 && (m = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + d.p.id + "_id' value='" + c + "'/></td></tr>"), m[0].rp = n + 999, a(e).append(m), b[o.p.id].checkOnSubmit || b[o.p.id].checkOnUpdate) && (b[o.p.id]._savedData[d.p.id + "_id"] = c),
                    p
                }
                function g(c, d, e) {
                    ...
                    a("#id_g", "#" + e).val(c);
                        ...
                        n && (a('td[role="gridcell"]', n).each(function(h) {
                            if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && !0 === m[h].editable) {
                                ...
                                case "checkbox":
                                    g = "" + g,
                                    m[h].editoptions && m[h].editoptions.value ? a("#" + f, "#" + e)[o.p.useProp ? "prop": "attr"](m[h].editoptions.value.split(":")[0] === g ? {
                                        checked: !0,
                                        defaultChecked: !0
                                    }: {
                                        checked: !1,
                ...
                function i() {
                    ...
                    a.isFunction(b[o.p.id].beforeCheckValues) && (q = b[o.p.id].beforeCheckValues.call(o, p, a("#" + t), r)) && "object" == typeof q && (p = q);
                    ...
                    if (h(), l[0] && (m = a(o).triggerHandler("jqGridAddEditClickSubmit", [b[o.p.id], p, r]), void 0 === m && a.isFunction(b[o.p.id].onclickSubmit) && (m = b[o.p.id].onclickSubmit.call(o, b[o.p.id], p, r) || {}), l = a(o).triggerHandler("jqGridAddEditBeforeSubmit", [p, a("#" + t), r]), void 0 === l && (l = [!0, "", ""]), l[0] && a.isFunction(b[o.p.id].beforeSubmit) && (l = b[o.p.id].beforeSubmit.call(o, p, a("#" + t), r))), l[0] && !b[o.p.id].processing) {
                        ...
                        !k.url && !b[o.p.id].useDataProxy && (a.isFunction(o.p.dataProxy) ? b[o.p.id].useDataProxy = !0 : (l[0] = !1, l[1] += " " + a.jgrid.errors.nourl)),
                        l[0] && (b[o.p.id].useDataProxy ? (m = o.p.dataProxy.call(o, k, "set_" + o.p.id), void 0 === m && (m = [!0, ""]), !1 === m[0] ? (l[0] = !1, l[1] = m[1] || "Error deleting the selected row!") : (k.data.oper === n.addoper && b[o.p.id].closeAfterAdd && a.jgrid.hideModal("#" + a.jgrid.jqID(w.themodal), {
                            gb: "#gbox_" + a.jgrid.jqID(s),
                            jqm: d.jqModal,
                            onClose: b[o.p.id].onClose
                ...
                function k() {
                    ...
                    e(), q = j(p, b[o.p.id]._savedData)) && (a("#" + t).data("disabled", !0), a(".confirm", "#" + w.themodal).show(), c = !1),
                    c
                }
                function l() {
                    var b;
                ...
                if (o.grid && c) {
                    ...
                    !0 === d.recreateForm && void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0] && a("#" + a.jgrid.jqID(w.themodal)).remove();
                    var E = !0;
                    if (d.checkOnUpdate && d.jqModal && !d.modal && (E = !1), void 0 !== a("#" + a.jgrid.jqID(w.themodal))[0]) {
                        ...
                        !0 === b[o.p.id].processing && (b[o.p.id].processing = !1, a("#sData", v + "_2").removeClass("ui-state-active")),
                        !0 === a("#" + t).data("disabled") && (a(".confirm", "#" + a.jgrid.jqID(w.themodal)).hide(), a("#" + t).data("disabled", !1)),
                        ...
                        a(F).append(G),
                        z = a("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='" + 2 * C + "'></td></tr>"),
                        z[0].rp = 0,
                        a(G).append(z),
                        z = a("<tr style='display:none' class='tinfo'><td class='topinfo' colspan='" + 2 * C + "'>" + b[o.p.id].topinfo + "</td></tr>"),
                        z[0].rp = 0,
                        a(G).append(z);
                        ...
                        var L = !1; ! 0 === d.closeOnEscape && (d.closeOnEscape = !1, L = !0),
                        u = a("<div></div>").append(F).append(u),
                        a.jgrid.createModal(w, u, d, "#gview_" + a.jgrid.jqID(o.p.id), a("#gbox_" + a.jgrid.jqID(o.p.id))[0]),
                        z && (a("#pData, #nData", v + "_2").css("float", "right"), a(".EditButton", v + "_2").css("text-align", "left")),
                        ...
                        a("#sData", v + "_2").click(function() {
                            ...
                            a("#FormError", v).hide(),
                            e(),
                            "_empty" === p[o.p.id + "_id"] ? i() : d.checkOnSubmit === !0 && (q = j(p, b[o.p.id]._savedData)) ? (a("#" + t).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(w.themodal)).show()) : i(),
                            !1
                        }),
        ...
        viewGridRow: function(c, d) {
            ...
            b[a(this)[0].p.id] = d,
            this.each(function() {
                function e() { (!0 === b[j.p.id].closeOnEscape || !0 === b[j.p.id].navkeys[0]) && setTimeout(function() {
                ...
                function f(b, c, e, f) {
                    ...
                    return a(c.p.colModel).each(function() {
                        ...
                        !h && "right" === this.align && (this.formatter && -1 !== a.inArray(this.formatter, u) ? v = Math.max(v, parseInt(this.width, 10)) : w = Math.max(w, parseInt(this.width, 10)))
                    }),
                    m = 0 !== v ? v: 0 !== w ? w: 0,
                    ...
                    a(c.p.colModel).each(function(b) {
                        if (g = this.name, n = !1, k = (h = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ? "style='display:none'": "", o = "boolean" != typeof this.viewable ? !0 : this.viewable, "cb" !== g && "subgrid" !== g && "rn" !== g && o) {
                            j = !1 === r ? "": g === c.p.ExpandColumn && !0 === c.p.treeGrid ? a("td:eq(" + b + ")", c.rows[r]).text() : a("td:eq(" + b + ")", c.rows[r]).html(),
                    ...
                    p > 0 && (b = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + b + "'/></td></tr>"), b[0].rp = p + 99, a(e).append(b)),
                    q
                }
                function g(b, c) {
                    var d, e, f, g, h = 0; (g = a(c).jqGrid("getInd", b, !0)) && (a("td", g).each(function(b) {
                        ...
                        "cb" !== d && "subgrid" !== d && "rn" !== d && (f = d === c.p.ExpandColumn && !0 === c.p.treeGrid ? a(this).text() : a(this).html(), d = a.jgrid.jqID("v_" + d), a("#" + d + " span", "#" + m).html(f), e && a("#" + d, "#" + m).parents("tr:first").hide(), h++)
                    }), h > 0 && a("#id_g", "#" + m).val(b))
                }
                function h(b, c) {
                    var d = c[1].length - 1;
                ...
                if (j.grid && c) {
                    ...
                    if (!0 === d.recreateForm && void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0] && a("#" + a.jgrid.jqID(p.themodal)).remove(), void 0 !== a("#" + a.jgrid.jqID(p.themodal))[0]) {
                        ...
                        n = a("<div></div>").append(n).append("<table border='0' class='EditTable' id='" + m + "_2'><tbody><tr id='Act_Buttons'><td class='navButton' width='" + d.labelswidth + "'>" + (o ? r + q: q + r) + "</td><td class='EditButton'>" + u + "</td></tr></tbody></table>"),
                        a.jgrid.createModal(p, n, d, "#gview_" + a.jgrid.jqID(j.p.id), a("#gview_" + a.jgrid.jqID(j.p.id))[0]),
                        o && (a("#pData, #nData", "#" + m + "_2").css("float", "right"), a(".EditButton", "#" + m + "_2").css("text-align", "left")),
                        ...
                        d.closeicon = a.extend([!0, "left", "ui-icon-close"], d.closeicon),
                        !0 === d.closeicon[0] && a("#cData", "#" + m + "_2").addClass("right" === d.closeicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.closeicon[2] + "'></span>"),
            ...
            this.each(function() {
                ...
                if (e.grid && c) {
                    ...
                    if (a.isArray(c) && (c = c.join()), void 0 !== a("#" + a.jgrid.jqID(r.themodal))[0]) {
                        ...
                        a("#DelError", "#" + p).hide(),
                        !0 === b[e.p.id].processing && (b[e.p.id].processing = !1, a("#dData", "#" + p).removeClass("ui-state-active")),
                        ...
                        !0 === d.delicon[0] && a("#dData", "#" + p + "_2").addClass("right" === d.delicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.delicon[2] + "'></span>"),
                        !0 === d.cancelicon[0] && a("#eData", "#" + p + "_2").addClass("right" === d.cancelicon[1] ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.cancelicon[2] + "'></span>"),
                        a("#dData", "#" + p + "_2").click(function() {
                            ...
                            a.isFunction(b[e.p.id].onclickSubmit) && (n = b[e.p.id].onclickSubmit.call(e, b[e.p.id], k) || {}), a.isFunction(b[e.p.id].beforeSubmit) && (j = b[e.p.id].beforeSubmit.call(e, k)), j[0] && !b[e.p.id].processing) {
                                ...
                                b[e.p.id].delData, n), i = h.oper, f[i] = h.deloper, g = h.id, k = ("" + k).split(","), !k.length) return ! 1;
                                ...
                                c.url || b[e.p.id].useDataProxy || (a.isFunction(e.p.dataProxy) ? b[e.p.id].useDataProxy = !0 : (j[0] = !1, j[1] = j[1] + (" " + a.jgrid.errors.nourl))),
                                j[0] && (b[e.p.id].useDataProxy ? (c = e.p.dataProxy.call(e, c, "del_" + e.p.id), void 0 === c && (c = [!0, ""]), c[0] === !1 ? (j[0] = !1, j[1] = c[1] || "Error deleting the selected row!") : a.jgrid.hideModal("#" + a.jgrid.jqID(r.themodal), {
                                    gb: "#gbox_" + a.jgrid.jqID(m),
                                    jqm: d.jqModal,
                                    onClose: b[e.p.id].onClose
                                })) : a.ajax(c))
                ...
                if (!this.nav) {
                    ...
                    if (k.grid && "string" == typeof b) {
                        ...
                        for (c.cloneToTop && k.p.toppager && (m = 2), l = 0; m > l; l++) {
                            ...
                            0 === l ? (p = b, q = k.p.id, p === k.p.toppager && (q += "_top", m = 1)) : (p = k.p.toppager, q = k.p.id + "_top"),
                            "rtl" === k.p.direction && a(r).attr("dir", "rtl").css("float", "right"),
                            c.add && (e = e || {},
                            i = a("<td class='ui-pg-button ui-corner-all'></td>"), a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + "</div>"), a("tr", r).append(i), a(i, r).attr({
                                title: c.addtitle || "",
                                id: e.id || "add_" + q
                            }).click(function() {
                                return a(this).hasClass("ui-state-disabled") || (a.isFunction(c.addfunc) ? c.addfunc.call(k) : a(k).jqGrid("editGridRow", "new", e)),
                                !1
                            }).hover(n, o), i = null),
                            c.edit && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), d = d || {},
                            a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + "</div>"), a("tr", r).append(i), a(i, r).attr({
                                title: c.edittitle || "",
                                id: d.id || "edit_" + q
                            }).click(function() {
                            ...
                            c.view && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), h = h || {},
                            a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.viewicon + "'></span>" + c.viewtext + "</div>"), a("tr", r).append(i), a(i, r).attr({
                                title: c.viewtitle || "",
                                id: h.id || "view_" + q
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                            ...
                            c.del && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), f = f || {},
                            a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + "</div>"), a("tr", r).append(i), a(i, r).attr({
                                title: c.deltitle || "",
                                id: f.id || "del_" + q
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    var b;
                                    k.p.multiselect ? (b = k.p.selarrrow, 0 === b.length && (b = null)) : b = k.p.selrow,
                                    b ? a.isFunction(c.delfunc) ? c.delfunc.call(k, b) : a(k).jqGrid("delGridRow", b, f) : (a.jgrid.viewModal("#" + j.themodal, {
                                        gbox: "#gbox_" + a.jgrid.jqID(k.p.id),
                                        jqm: !0
                                    }), a("#jqg_alrt").focus())
                                }
                            ...
                            (c.add || c.edit || c.del || c.view) && a("tr", r).append("<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>"),
                            c.search && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), g = g || {},
                            a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.searchicon + "'></span>" + c.searchtext + "</div>"), a("tr", r).append(i), a(i, r).attr({
                                title: c.searchtitle || "",
                                id: g.id || "search_" + q
                            }).click(function() {
                                return a(this).hasClass("ui-state-disabled") || (a.isFunction(c.searchfunc) ? c.searchfunc.call(k, g) : a(k).jqGrid("searchGrid", g)),
                                !1
                            }).hover(n, o), g.showOnLoad && !0 === g.showOnLoad && a(i, r).click(), i = null),
                            c.refresh && (i = a("<td class='ui-pg-button ui-corner-all'></td>"), a(i).append("<div class='ui-pg-div'><span class='ui-icon " + c.refreshicon + "'></span>" + c.refreshtext + "</div>"), a("tr", r).append(i), a(i, r).attr({
                                title: c.refreshtitle || "",
                                id: "refresh_" + q
                            }).click(function() {
                                if (!a(this).hasClass("ui-state-disabled")) {
                                    a.isFunction(c.beforeRefresh) && c.beforeRefresh.call(k),
                                    k.p.search = !1;
                                    try {
                                        var b = k.p.id;
                            ...
                            k.p._nvtd && (i > k.p._nvtd[0] && (a(p + "_" + c.position, p).width(i), k.p._nvtd[0] = i), k.p._nvtd[1] = i),
                            r = i = i = null,
                            this.nav = !0
                        }
                    }
                ...
                this.p.filter), d) {
                    ...
                    this.createTableForGroup = function(b, c) {
                        ...
                        if (g.append(i), h = a("<th colspan='5' align='" + h + "'></th>"), i.append(h), !0 === this.p.ruleButtons) {
                            ...
                            h.append(j);
                            var k, i = "";
                            for (d = 0; d < e.groupOps.length; d++) k = b.groupOp === f.p.groupOps[d].op ? " selected='selected'": "",
                            i += "<option value='" + f.p.groupOps[d].op + "'" + k + ">" + f.p.groupOps[d].text + "</option>";
                            j.append(i).bind("change",
                            function() {
                                b.groupOp = a(j).val(),
                                f.onchange()
                            })
                        }
                        if (i = "<span></span>", this.p.groupButton && (i = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>"), i.bind("click",
                        function() {
                            ...
                            function() {
                                ...
                                return c = l.searchoptions.sopt ? l.searchoptions.sopt: f.p.sopt ? f.p.sopt: -1 !== a.inArray(l.searchtype, f.p.strarr) ? f.p.stropts: f.p.numopts,
                                b.rules.push({
                                    field: l.name,
                                    op: c[0],
                                    data: ""
                        ...
                        if (null !== c && (i = a("<input type='button' value='-' title='Delete group' class='delete-group'/>"), h.append(i), i.bind("click",
                        function() {
                            ...
                            f.onchange(),
                            !1
                        })), void 0 !== b.groups) for (d = 0; d < b.groups.length; d++) h = a("<tr></tr>"),
                        g.append(h),
                    ...
                    this.createTableRowForRule = function(b, c) {
                        ...
                        function() {
                            ...
                            if (j) {
                                ...
                                f && "text" === j.inputtype && !j.searchoptions.size && (j.searchoptions.size = 10);
                                var c = a.jgrid.createEl.call(m, j.inputtype, j.searchoptions, "", !0, l.p.ajaxSelectOptions || {},
                                !0);
                                ...
                                var e = "",
                                g = 0;
                                for (s = [], a.each(l.p.ops,
                                function() {
                                    s.push(this.oper)
                                }), d = 0; d < h.length; d++) q = a.inArray(h[d], s),
                                -1 !== q && (0 === g && (b.op = l.p.ops[q].oper), e += "<option value='" + l.p.ops[q].oper + "'>" + l.p.ops[q].text + "</option>", g++);
                                a(".selectopts", i).empty().append(e),
                                a(".selectopts", i)[0].selectedIndex = 0,
                                a.jgrid.msie && 9 > a.jgrid.msiever() && (e = parseInt(a("select.selectopts", i)[0].offsetWidth, 10) + 1, a(".selectopts", i).width(e), a(".selectopts", i).css("width", "auto")),
                                a(".data", i).empty().append(c),
                                a.jgrid.bindEv.call(m, c, j.searchoptions),
                                a(".input-elm", i).bind("change",
                                function(c) {
                                    var d = a(this).hasClass("ui-autocomplete-input") ? 200 : 0;
                                    setTimeout(function() {
                                        var d = c.target;
                                        b.data = "SPAN" === d.nodeName.toUpperCase() && j.searchoptions && a.isFunction(j.searchoptions.custom_value) ? j.searchoptions.custom_value.call(m, a(d).children(".customelement:first"), "get") : d.value,
                                        l.onchange()
                                    },
                                    d)
                                }),
                            ...
                            var t = !0 === l.p.columns[d].hidden; (!0 === l.p.columns[d].searchoptions.searchhidden && k || k && !t) && (k = "", b.field === l.p.columns[d].name && (k = " selected='selected'", p = d), o += "<option value='" + l.p.columns[d].name + "'" + k + ">" + l.p.columns[d].label + "</option>")
                        }
                        r.append(o),
                        ...
                        j.searchoptions.id = a.jgrid.randId(),
                        f && "text" === j.inputtype && !j.searchoptions.size && (j.searchoptions.size = 10),
                        p = a.jgrid.createEl.call(m, j.inputtype, j.searchoptions, b.data, !0, l.p.ajaxSelectOptions || {},
                        !0),
                        ("nu" === b.op || "nn" === b.op) && (a(p).attr("readonly", "true"), a(p).attr("disabled", "true"));
                        var u = a("<select class='selectopts'></select>");
                        for (o.append(u), u.bind("change",
                        function() {
                            b.op = a(u).val(),
                            ...
                            l.onchange()
                        }), h = j.searchoptions.sopt ? j.searchoptions.sopt: l.p.sopt ? l.p.sopt: -1 !== a.inArray(j.searchtype, l.p.strarr) ? l.p.stropts: l.p.numopts, o = "", a.each(l.p.ops,
                        function() {
                            s.push(this.oper)
                        }), d = 0; d < h.length; d++) q = a.inArray(h[d], s),
                        -1 !== q && (k = b.op === l.p.ops[q].oper ? " selected='selected'": "", o += "<option value='" + l.p.ops[q].oper + "'" + k + ">" + l.p.ops[q].text + "</option>");
                        return u.append(o),
                        ...
                        function() {
                            b.data = "custom" === j.inputtype ? j.searchoptions.custom_value.call(m, a(this).children(".customelement:first"), "get") : a(this).val(),
                            l.onchange()
                        }),
                        o = a("<td></td>"),
                        n.append(o),
                        !0 === this.p.ruleButtons && (p = a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>"), o.append(p), p.bind("click",
                        function() {
                    ...
                    this.getStringForGroup = function(a) {
                        ...
                        if (void 0 !== a.rules) try {
                            for (b = 0; b < a.rules.length; b++) 1 < c.length && (c += " " + a.groupOp + " "),
                    ...
                    this.getStringForRule = function(b) {
                        ...
                        for (c = 0; c < this.p.ops.length; c++) if (this.p.ops[c].oper === b.op) {
                            f = this.p.operands.hasOwnProperty(b.op) ? this.p.operands[b.op] : "",
                            g = this.p.ops[c].oper;
                            break
                        }
                    ...
                    this.toString = function() {
                        function a(c) {
                            var d, e = "(";
                            if (void 0 !== c.groups) for (d = 0; d < c.groups.length; d++) 1 < e.length && (e = "OR" === c.groupOp ? e + " || ": e + " && "),
                            e += a(c.groups[d]);
                            if (void 0 !== c.rules) for (d = 0; d < c.rules.length; d++) {
                                ...
                                if (b.p.errorcheck) {
                                    for (var g = void 0,
                                    i = void 0,
                                    g = 0; g < b.p.columns.length; g++) if (b.p.columns[g].name === f.field) {
                                        i = b.p.columns[g];
                                        break
                                    }
                                    i && h(f.data, i)
            ...
            this.each(function() {
                ...
                h.grid && (e = a(h).jqGrid("getInd", b, !0), !1 !== e && (g = a.isFunction(k.beforeEditRow) ? k.beforeEditRow.call(h, k, b) : void 0, void 0 === g && (g = !0), g && "0" === (a(e).attr("editable") || "0") && !a(e).hasClass("not-editable-row"))) && (f = h.p.colModel, a('td[role="gridcell"]', e).each(function(e) {
                    ...
                    if ("cb" !== c && "subgrid" !== c && "rn" !== c && (h.p.autoencode && (d = a.jgrid.htmlDecode(d)), l[c] = d, !0 === f[e].editable)) {
                        ...
                        ("&nbsp;" === d || "&#160;" === d || 1 === d.length && 160 === d.charCodeAt(0)) && (d = "");
                        var n = a.jgrid.createEl.call(h, f[e].edittype, m, d, !0, a.extend({},
                        ...
                        "select" === f[e].edittype && void 0 !== f[e].editoptions && !0 === f[e].editoptions.multiple && void 0 === f[e].editoptions.dataUrl && a.jgrid.msie && a(n).width(a(n).width()),
                        i++
                    }
                }), i > 0 && (l.id = b, h.p.savedRow.push(l), a(e).attr("editable", "1"), a("td:eq(" + j + ") input", e).focus(), !0 === k.keys && a(e).bind("keydown",
                function(c) {
                    if (27 === c.keyCode) {
            ...
            if (i = a.isFunction(j.beforeSaveRow) ? j.beforeSaveRow.call(p, j, b) : void 0, void 0 === i && (i = !0), i) {
                if (i = a(n).attr("editable"), j.url = j.url || p.p.editurl, "1" === i) {
                    ...
                    if (a('td[role="gridcell"]', n).each(function(b) {
                        if (t = p.p.colModel[b], k = t.name, "cb" !== k && "subgrid" !== k && !0 === t.editable && "rn" !== k && !a(this).hasClass("not-editable-cell")) {
                            ...
                            case "checkbox":
                                ...
                                q[k] = a("input", this).is(":checked") ? c[0] : c[1];
                                break;
                            case "text":
                            case "password":
                            case "textarea":
                            ...
                            case "select":
                                if (t.editoptions.multiple) {
                                    ...
                                    r[k] = d.join(",")
                                } else q[k] = a("select option:selected", this).val(),
                            ...
                            "clientArray" !== j.url && t.editoptions && !0 === t.editoptions.NullIfEmpty && "" === q[k] && (s[k] = "null")
                        }
                    }), !1 === m[0]) {
                        try {
                    ...
                    q, p.p.inlineData, j.extraparam)), "clientArray" === j.url) {
                        ...
                        a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(p, b, i, j),
                        o = !0,
                        a(n).removeClass("jqgrid-new-row").unbind("keydown")
                    } else a("#lui_" + a.jgrid.jqID(p.p.id)).show(),
                    s = a.extend({},
                    q, s),
                        ...
                        complete: function(c, d) {
                            if (a("#lui_" + a.jgrid.jqID(p.p.id)).hide(), "success" === d) {
                                ...
                                if (e = a(p).triggerHandler("jqGridInlineSuccessSaveRow", [c, b, j]), a.isArray(e) || (e = [!0, q]), e[0] && a.isFunction(j.successfunc) && (e = j.successfunc.call(p, c)), a.isArray(e) ? (f = e[0], q = e[1] || q) : f = e, !0 === f) {
                                    for (p.p.autoencode && a.each(q,
                                    function(b, c) {
                                        q[b] = a.jgrid.htmlDecode(c)
                                    }), q = a.extend({},
                                    q, r), a(p).jqGrid("setRowData", b, q), a(n).attr("editable", "0"), f = 0; f < p.p.savedRow.length; f++) if ("" + p.p.savedRow[f].id == "" + b) {
                                        l = f;
                                        break
                                    }
                                    l >= 0 && p.p.savedRow.splice(l, 1),
                                    a(p).triggerHandler("jqGridInlineAfterSaveRow", [b, c, q, j]),
                                    a.isFunction(j.aftersavefunc) && j.aftersavefunc.call(p, b, c),
                                    o = !0,
                                    a(n).removeClass("jqgrid-new-row").unbind("keydown")
                                } else a(p).triggerHandler("jqGridInlineErrorSaveRow", [b, c, d, null, j]),
                                a.isFunction(j.errorfunc) && j.errorfunc.call(p, b, c, d, null),
            ...
            this.each(function() {
                ...
                if (g.grid && (d = a(g).jqGrid("getInd", b, !0), d !== !1 && (f = a.isFunction(e.beforeCancelRow) ? e.beforeCancelRow.call(g, cancelPrm, sr) : void 0, void 0 === f && (f = !0), f))) {
                    ...
                    if (c >= 0) {
                        ...
                        a("#" + a.jgrid.jqID(b), "#" + a.jgrid.jqID(g.p.id)).hasClass("jqgrid-new-row") && setTimeout(function() {
                    ...
                    a.isFunction(e.afterrestorefunc) && e.afterrestorefunc.call(g, b)
                }
            })
        },
        addRow: function(b) {
            ...
            this.each(function() {
                if (this.grid) {
                    ...
                    void 0 === d && (d = !0),
                    d && (b.rowID = a.isFunction(b.rowID) ? b.rowID.call(c, b) : null != b.rowID ? b.rowID: a.jgrid.randId(), !0 === b.useDefValues && a(c.p.colModel).each(function() {
                ...
                if (this.grid) {
                    ...
                    c.add && a(e).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function() {
                            ...
                            c.addParams.useFormatter || (a("#" + f + "_ilsave").removeClass("ui-state-disabled"), a("#" + f + "_ilcancel").removeClass("ui-state-disabled"), a("#" + f + "_iladd").addClass("ui-state-disabled"), a("#" + f + "_iledit").addClass("ui-state-disabled"))
                        }
                    }),
                    ...
                    c.save && (a(e).jqGrid("navButtonAdd", b, {
                        ...
                        onClickButton: function() {
                            ...
                            if (b) {
                                ...
                                g = d.oper,
                                h = {};
                                a("#" + a.jgrid.jqID(b), "#" + f).hasClass("jqgrid-new-row") ? (c.addParams.addRowParams.extraparam[g] = d.addoper, h = c.addParams.addRowParams) : (c.editParams.extraparam || (c.editParams.extraparam = {}), c.editParams.extraparam[g] = d.editoper, h = c.editParams),
                                a(e).jqGrid("saveRow", b, h) && a(e).jqGrid("showAddEditButtons")
                    ...
                    !0 === c.restoreAfterSelect && (d = a.isFunction(e.p.beforeSelectRow) ? e.p.beforeSelectRow: !1, e.p.beforeSelectRow = function(b, f) {
                        var g = !0;
                        return e.p.savedRow.length > 0 && e.p._inlinenav === !0 && b !== e.p.selrow && null !== e.p.selrow && (e.p.selrow === c.addParams.rowID ? a(e).jqGrid("delRowData", e.p.selrow) : a(e).jqGrid("restoreRow", e.p.selrow, c.editParams), a(e).jqGrid("showAddEditButtons")),
                        d && (g = d.call(e, b, f)),
                        g
                    })
                }
            ...
            return this.each(function() {
                ...
                if (i.grid && !0 === i.p.cellEdit) {
                    ...
                    if (h = i.p.colModel[c], e = h.name, "subgrid" !== e && "cb" !== e && "rn" !== e) {
                        if (g = a("td:eq(" + c + ")", i.rows[b]), !0 !== h.editable || !0 !== d || g.hasClass("not-editable-cell")) 0 <= parseInt(i.p.iCol, 10) && 0 <= parseInt(i.p.iRow, 10) && (a("td:eq(" + i.p.iCol + ")", i.rows[i.p.iRow]).removeClass("edit-cell ui-state-highlight"), a(i.rows[i.p.iRow]).removeClass("selected-row ui-state-hover")),
                        ...
                        a.isFunction(i.p.onSelectCell) && i.p.onSelectCell.call(i, i.rows[b].id, e, f, b, c);
                            ...
                            0 <= parseInt(i.p.iCol, 10) && 0 <= parseInt(i.p.iRow, 10) && (a("td:eq(" + i.p.iCol + ")", i.rows[i.p.iRow]).removeClass("edit-cell ui-state-highlight"), a(i.rows[i.p.iRow]).removeClass("selected-row ui-state-hover")),
                            ...
                            l = a.jgrid.createEl.call(i, h.edittype, k, f, !0, a.extend({},
                            ...
                            function(d) {
                                if (27 === d.keyCode && (a("input.hasDatepicker", g).length > 0 ? a(".ui-datepicker").is(":hidden") ? a(i).jqGrid("restoreCell", b, c) : a("input.hasDatepicker", g).datepicker("hide") : a(i).jqGrid("restoreCell", b, c)), 13 === d.keyCode) return a(i).jqGrid("saveCell", b, c),
                                !1;
                                if (9 === d.keyCode) {
                ...
                if (e.grid && !0 === e.p.cellEdit) {
                    if (d = 1 <= e.p.savedRow.length ? 0 : null, null !== d) {
                        ...
                        case "checkbox":
                            ...
                            g = f = a("#" + b + "_" + k, e.rows[b]).is(":checked") ? m[0] : m[1];
                            break;
                        case "password":
                        case "text":
                        case "textarea":
                        ...
                        case "custom":
                            try {
                                ...
                                "e1" === n && a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.nodefined, a.jgrid.edit.bClose),
                                "e2" === n ? a.jgrid.info_dialog(a.jgrid.errors.errcap, "function 'custom_value' " + a.jgrid.edit.msg.novalue, a.jgrid.edit.bClose) : a.jgrid.info_dialog(a.jgrid.errors.errcap, n.message, a.jgrid.edit.bClose)
                            }
                        }
                        if (g !== e.p.savedRow[d].v) { (d = a(e).triggerHandler("jqGridBeforeSaveCell", [e.rows[b].id, j, f, b, c])) && (g = f = d),
                            a.isFunction(e.p.beforeSaveCell) && (d = e.p.beforeSaveCell.call(e, e.rows[b].id, j, f, b, c)) && (g = f = d);
                            var o = a.jgrid.checkValues.call(e, f, c);
                            if (!0 === o[0]) {
                                if (d = a(e).triggerHandler("jqGridBeforeSubmitCell", [e.rows[b].id, j, f, b, c]) || {},
                                a.isFunction(e.p.beforeSubmitCell) && ((d = e.p.beforeSubmitCell.call(e, e.rows[b].id, j, f, b, c)) || (d = {})), 0 < a("input.hasDatepicker", h).length && a("input.hasDatepicker", h).datepicker("hide"), "remote" === e.p.cellsubmit) if (e.p.cellurl) {
                                    var p = {};
                                    ...
                                    a.ajax(a.extend({
                                        ...
                                        complete: function(d, i) {
                                            if (a("#lui_" + e.p.id).hide(), e.grid.hDiv.loading = !1, "success" === i) {
                                                ...
                                                k[0] === !0 && a.isFunction(e.p.afterSubmitCell) && (k = e.p.afterSubmitCell.call(e, d, p.id, j, f, b, c)),
                                        ...
                                        error: function(d, f, g) {
                                            ...
                                            a.isFunction(e.p.errorCell) ? e.p.errorCell.call(e, d, f, g) : a.jgrid.info_dialog(a.jgrid.errors.errcap, d.status + " : " + d.statusText + "<br/>" + f, a.jgrid.edit.bClose),
...
function(a) {
    ...
    a.jqm = {
        ...
        open: function(b, h) {
            ...
            1), d.push(b)) : 0 < j.overlay ? j.closeoverlay && i.w.jqmAddClose(m) : m = e, i.o = m ? m.addClass(j.overlayClass).prependTo("body") : e, j.ajax ? (l = j.target || i.w, m = j.ajax, l = "string" == typeof l ? a(l, i.w) : a(l), m = "@" == m.substr(0, 1) ? a(h).attr(m.substring(1)) : m, l.html(j.ajaxText).load(m,
            function() {
        ...
        close: function(b) {
            return b = c[b],
            b.a ? (b.a = e, d[0] && (d.pop(), d[0] || g("unbind")), b.c.toTop && b.o && a("#jqmP" + b.w[0]._jqm).after(b.w).remove(), b.c.onHide ? b.c.onHide(b) : (b.w.hide(), b.o && b.o.remove()), e) : e
        },
        params: {}
    };
    var b = 0,
            ...
            return this.each(function() {
                ...
                if (d.grid) {
                    ...
                    k = function(b, c) {
                        ...
                        i = a("<tr></tr>");
                        for (f = 0; f < d.p.subGridModel[0].name.length; f++) e = a("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + d.p.direction + "'></th>"),
                    ...
                    l = function(b, c) {
                        ...
                        return f = a("table:first", d.grid.bDiv).attr("id") + "_",
                    ...
                    n = 0;
                    a.each(d.p.colModel,
                    function() { (!0 === this.hidden || "rn" === this.name || "cb" === this.name) && n++
                    });
                    var o = d.rows.length,
                    p = 1;
                    for (void 0 !== c && c > 0 && (p = c, o = c + 1); o > p;) a(d.rows[p]).hasClass("jqgrow") && a(d.rows[p].cells[b]).bind("click",
                    function() {
                        ...
                        if (i = c.nextSibling, a(this).hasClass("sgcollapsed")) {
                            if (f = d.p.id, e = c.id, d.p.subGridOptions.reloadOnExpand === !0 || d.p.subGridOptions.reloadOnExpand === !1 && !a(i).hasClass("ui-subgrid")) {
                                ...
                                a(c).after("<tr role='row' class='ui-subgrid'>" + g + "<td class='ui-widget-content subgrid-cell'><span class='ui-icon " + d.p.subGridOptions.openicon + "'></span></td><td colspan='" + parseInt(d.p.colNames.length - 1 - n, 10) + "' class='ui-widget-content subgrid-data'><div id=" + f + "_" + e + " class='tablediv'></div></td></tr>"),
                                a(d).triggerHandler("jqGridSubGridRowExpanded", [f + "_" + e, e]),
                                a.isFunction(d.p.subGridRowExpanded) ? d.p.subGridRowExpanded.call(d, f + "_" + e, e) : m(c)
                            } else a(i).show();
                            a(this).html("<a style='cursor:pointer;'><span class='ui-icon " + d.p.subGridOptions.minusicon + "'></span></a>").removeClass("sgcollapsed").addClass("sgexpanded"),
                            ...
                            d.p.subGridOptions.reloadOnExpand === !0 ? a(i).remove(".ui-subgrid") : a(i).hasClass("ui-subgrid") && a(i).hide(),
                            a(this).html("<a style='cursor:pointer;'><span class='ui-icon " + d.p.subGridOptions.plusicon + "'></span></a>").removeClass("sgexpanded").addClass("sgcollapsed"),
                            d.p.subGridOptions.selectOnCollapse && a(d).jqGrid("setSelection", e)
                        }
                        return ! 1
                    }),
                    p++; ! 0 === d.p.subGridOptions.expandOnLoad && a(d.rows).filter(".jqgrow").each(function(b, c) {
                        a(c.cells[0]).click()
                    }),
    ...
    a.jgrid.extend({
        groupingSetup: function() {
            return this.each(function() {
                ...
                if (null === e || "object" != typeof e && !a.isFunction(e)) this.p.grouping = !1;
                    ...
                    for (void 0 === e.visibiltyOnNextGrouping && (e.visibiltyOnNextGrouping = []), e.lastvalues = [], e.groups = [], e.counters = [], b = 0; b < e.groupField.length; b++) e.groupOrder[b] || (e.groupOrder[b] = "asc"),
                    e.groupText[b] || (e.groupText[b] = "{0}"),
                    "boolean" != typeof e.groupColumnShow[b] && (e.groupColumnShow[b] = !0),
                    "boolean" != typeof e.groupSummary[b] && (e.groupSummary[b] = !1),
                    !0 === e.groupColumnShow[b] ? (e.visibiltyOnNextGrouping[b] = !0, a(this).jqGrid("showCol", e.groupField[b])) : (e.visibiltyOnNextGrouping[b] = a("#" + a.jgrid.jqID(this.p.id + "_" + e.groupField[b])).is(":visible"), a(this).jqGrid("hideCol", e.groupField[b]));
        ...
        groupingPrepare: function(b, c, d, e) {
            return this.each(function() {
                ...
                m = 0;
                for (f = 0; l > f; f++) g = j.groupField[f],
                i = j.displayField[f],
                h = d[g],
                i = null == i ? null: d[i],
                null == i && (i = h),
                void 0 !== h && (0 === e ? (j.groups.push({
                    idx: f,
                    dataIndex: g,
                    value: h,
                    displayValue: i,
            ...
            return this.each(function() {
                ...
                if (j.hasClass(d)) {
                    if (c.showSummaryOnHide) {
                        if (i) for (; i && !(a(i).hasClass("jqfoot") && parseInt(a(i).attr("jqfootlevel"), 10) <= e);) a(i).hide(),
                        i = i.nextSibling
                    } else if (i) for (; i && (c = k(i.className), !(void 0 !== c && e >= c));) a(i).hide(),
                    i = i.nextSibling;
                    j.removeClass(d).addClass(h),
                    l = !0
                } else {
                    if (i) for (f = void 0; i;) {
                ...
                a.isFunction(this.p.onClickGroup) && this.p.onClickGroup.call(this, b, l)
            }),
            !1
        },
        groupingRender: function(b, c) {
            return this.each(function() {
                ...
                function(q, r) {
                    ...
                    e = f + "_" + q,
                    k = "<span style='cursor:pointer;' class='ui-icon " + l + "' onclick=\"jQuery('#" + a.jgrid.jqID(h.p.id) + "').jqGrid('groupingToggle','" + e + "');return false;\"></span>";
                    try {
                    ...
                    if (j += '<tr id="' + e + '"' + (i.groupCollapse && 0 < r.idx ? ' style="display:none;" ': " ") + 'role="row" class= "ui-widget-content jqgroup ui-row-' + h.p.direction + " " + f + '"><td style="padding-left:' + 12 * r.idx + 'px;" colspan="' + c + '">' + k + a.jgrid.template(i.groupText[r.idx], g, r.cnt, r.summary) + "</td></tr>", n - 1 === r.idx) {
                        ...
                        for (v = 0; o > v; v++) if (p[v]) {
                            u = "",
                            i.groupCollapse && !i.showSummaryOnHide && (u = ' style="display:none;"'),
                            j += "<tr" + u + ' jqfootlevel="' + (r.idx - v) + '" role="row" class="ui-widget-content jqfoot ui-row-' + h.p.direction + '">',
                            u = d(q, v, i.groups);
                            ...
                            for (t = 0; c > t; t++) {
                                ...
                                function() {
                                    if (this.nm === z[t].name) {
                                        ...
                                        "string" == typeof this.st && "avg" === this.st.toLowerCase() && (this.sd && this.vd ? this.v /= this.vd: this.v && A > 0 && (this.v /= A));
                                        try {
                                            y = h.formatter("", this.v, t, this)
                                        } catch(b) {
                                            y = this.v
                                        }
                                        return B = "<td " + h.formatCol(t, 1, "") + ">" + a.jgrid.format(C, y) + "</td>",
                                        !1
                                    }
                                }),
                                j += B
        ...
        groupingCalculations: {
            handler: function(a, b, c, d, e, f) {
                ...
                return a = g[a](),
                null != d && ("fixed" === e ? a = a.toFixed(d) : (d = Math.pow(10, d), a = Math.round(a * d) / d)),
                a
            }
        }
    })
...
function(a) {
    a.jgrid.extend({
        setTreeNode: function(b, c) {
            return this.each(function() {
                var d = this;
                if (d.grid && d.p.treeGrid) for (var e, f, g, h, i = d.p.expColInd,
                j = d.p.treeReader.expanded_field,
                k = d.p.treeReader.leaf_field,
                l = d.p.treeReader.level_field,
                m = d.p.treeReader.icon_field,
                n = d.p.treeReader.loaded; c > b;) h = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id),
                h = d.p.data[d.p._index[h]],
                "nested" === d.p.treeGridModel && !h[k] && (e = parseInt(h[d.p.treeReader.left_field], 10), f = parseInt(h[d.p.treeReader.right_field], 10), h[k] = f === e + 1 ? "true": "false", d.rows[b].cells[d.p._treeleafpos].innerHTML = h[k]),
                e = parseInt(h[l], 10),
                0 === d.p.tree_root_level ? (g = e + 1, f = e) : (g = e, f = e - 1),
                g = "<div class='tree-wrap tree-wrap-" + d.p.direction + "' style='width:" + 18 * g + "px;'>",
                g += "<div style='" + ("rtl" === d.p.direction ? "right:": "left:") + 18 * f + "px;' class='ui-icon ",
                void 0 !== h[n] && (h[n] = "true" === h[n] || !0 === h[n] ? !0 : !1),
                "true" === h[k] || !0 === h[k] ? (g += (void 0 !== h[m] && "" !== h[m] ? h[m] : d.p.treeIcons.leaf) + " tree-leaf treeclick", h[k] = !0, f = "leaf") : (h[k] = !1, f = ""),
                h[j] = ("true" === h[j] || !0 === h[j] ? !0 : !1) && (h[n] || void 0 === h[n]),
                g = !1 === h[j] ? g + (!0 === h[k] ? "'": d.p.treeIcons.plus + " tree-plus treeclick'") : g + (!0 === h[k] ? "'": d.p.treeIcons.minus + " tree-minus treeclick'"),
                g += "></div></div>",
                a(d.rows[b].cells[i]).wrapInner("<span class='cell-wrapper" + f + "'></span>").prepend(g),
                e !== parseInt(d.p.tree_root_level, 10) && ((h = (h = a(d).jqGrid("getNodeParent", h)) && h.hasOwnProperty(j) ? h[j] : !0) || a(d.rows[b]).css("display", "none")),
                a(d.rows[b].cells[i]).find("div.treeclick").bind("click",
                function(b) {
                    return b = a.jgrid.stripPref(d.p.idPrefix, a(b.target || b.srcElement, d.rows).closest("tr.jqgrow")[0].id),
                    b = d.p._index[b],
                    d.p.data[b][k] || (d.p.data[b][j] ? (a(d).jqGrid("collapseRow", d.p.data[b]), a(d).jqGrid("collapseNode", d.p.data[b])) : (a(d).jqGrid("expandRow", d.p.data[b]), a(d).jqGrid("expandNode", d.p.data[b]))),
                    !1
                }),
                !0 === d.p.ExpandColClick && a(d.rows[b].cells[i]).find("span.cell-wrapper").css("cursor", "pointer").bind("click",
                function(b) {
                    var b = a.jgrid.stripPref(d.p.idPrefix, a(b.target || b.srcElement, d.rows).closest("tr.jqgrow")[0].id),
                    c = d.p._index[b];
                    return d.p.data[c][k] || (d.p.data[c][j] ? (a(d).jqGrid("collapseRow", d.p.data[c]), a(d).jqGrid("collapseNode", d.p.data[c])) : (a(d).jqGrid("expandRow", d.p.data[c]), a(d).jqGrid("expandNode", d.p.data[c]))),
        ...
        getRootNodes: function() {
            ...
            return this.each(function() {
                ...
                case "adjacency":
                    ...
                    a(c.p.data).each(function() { (null === this[e] || "null" === ("" + this[e]).toLowerCase()) && b.push(this)
                    })
                }
            }),
            b
        ...
        SortTree: function(b, c, d, e) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var f, g, h, i, j = [],
                    k = this;
                    for (f = a(this).jqGrid("getRootNodes"), f = a.jgrid.from(f), f.orderBy(b, c, d, e), i = f.select(), f = 0, g = i.length; g > f; f++) h = i[f],
                    j.push(h),
        ...
        collectChildrenSortTree: function(b, c, d, e, f, g) {
            return this.each(function() {
                if (this.grid && this.p.treeGrid) {
                    var h, i, j, k;
                    for (h = a(this).jqGrid("getNodeChildren", c), h = a.jgrid.from(h), h.orderBy(d, e, f, g), k = h.select(), h = 0, i = k.length; i > h; h++) j = k[h],
                    b.push(j),
        ...
        addChildNode: function(b, c, d, e) {
            ...
            if (d) {
                ...
                if (void 0 === e && (e = !1), void 0 === b || null === b) {
                    if (k = f.p.data.length - 1, k >= 0) for (; k >= 0;) g = Math.max(g, parseInt(f.p.data[k][f.p.localReader.id], 10)),
                    k--;
                    b = g + 1
                }
                ...
                } (null === c || a(f).jqGrid("isNodeLoaded", i) || s) && (a(f).jqGrid("addRowData", b, d, g, t), a(f).jqGrid("setTreeNode", k, h)),
    ...
    a.jgrid.extend({
            ...
            this.each(function() {
                ...
                e = function(b, d) {
                    if (b && "string" == typeof b) {
                        ...
                        if (e && (a.jgrid.useJSON = !0), e = f[d.jsonGrid.config], f = f[d.jsonGrid.data]) {
                            ...
                            e.datastr = f,
                            a(c).jqGrid(e).jqGrid("setGridParam", {
                                datatype: g
                            })
                        } else a(c).jqGrid(e)
                    }
                ...
                case "xmlstring":
                    if (b.impstring && "string" == typeof b.impstring) {
                        ...
                        f && (d(f, b), a(c).triggerHandler("jqGridImportComplete", [f, b]), a.isFunction(b.importComplete) && b.importComplete(f), b.impstring = null),
                        f = null
                    }
                    break;
                case "json":
            ...
            return this.each(function() {
                if (this.grid) {
                    ...
                    case "jsonstring":
                        ...
                        void 0 !== e.postData.filters && (c = c.replace(/filters":"/, 'filters":'), c = c.replace(/}]}"/, "}]}"))
                    }
                }
            }),
            c
        ...
        excelExport: function(b) {
            ...
            this.each(function() {
                if (this.grid) {
                    var c;
                    "remote" === b.exptype && (c = a.extend({},
                    this.p.postData), c[b.oper] = b.tag, c = jQuery.param(c), c = -1 !== b.url.indexOf("?") ? b.url + "&" + c: b.url + "?" + c, window.location = c)
                }
            })
        }
    })
    ...
    b.jgrid.extend({
        sortableColumns: function(a) {
            return this.each(function() {
                ...
                d.p.sortable.exclude && (e.items = e.items + (":not(" + d.p.sortable.exclude + ")")),
        ...
        columnChooser: function(a) {
            ...
            if (!b("#colchooser_" + b.jgrid.jqID(d[0].p.id)).length) {
                ...
                a.height && (b(">div", e).css("height", a.height), f.css("height", a.height - 10));
                ...
                function(a) {
                    i[this.name] = a,
                    this.hidedlg ? this.hidden || j.push(a) : f.append("<option value='" + a + "' " + (this.hidden ? "": "selected='selected'") + ">" + b.jgrid.stripHtml(h[a]) + "</option>")
                });
                var k = b.isFunction(a.dlog_opts) ? a.dlog_opts.call(d, a) : a.dlog_opts;
                c(a.dlog, e, k),
                k = b.isFunction(a.msel_opts) ? a.msel_opts.call(d, a) : a.msel_opts,
                c(a.msel, f, k)
            }
        },
        sortableRows: function(a) {
            return this.each(function() {
                ...
                a.update = function(d, e) {
                    ...
                    c.p.rownumbers === !0 && b("td.jqgrid-rownum", c.rows).each(function(a) {
        ...
        gridDnD: function(a) {
            return this.each(function() {
                            ...
                            drop: function(c, d) {
                                if (b(d.draggable).hasClass("jqgrow")) {
                                    ...
                                    if (d.helper.dropped = !0, a.beforedrop && b.isFunction(a.beforedrop) && (g = a.beforedrop.call(this, c, d, e, b("#" + b.jgrid.jqID(f.p.id)), b(this)), void 0 !== g && null !== g && "object" == typeof g && (e = g)), d.helper.dropped) {
                                        var m;
                                        a.autoid && (b.isFunction(a.autoid) ? m = a.autoid.call(this, e) : (m = Math.ceil(1e3 * Math.random()), m = a.autoidprefix + m)),
                                        b("#" + b.jgrid.jqID(this.id)).jqGrid("addRowData", m, e, a.droppos)
                                    }
                ...
                function(a) {
                    return b.trim(a)
                }), b.data(f, "dnd", a), 0 !== f.p.reccount && !f.p.jqgdnd && c(), f.p.jqgdnd = !0, d = 0; d < a.connectWith.length; d++) e = a.connectWith[d],
                b(e).droppable(b.isFunction(a.drop) ? a.drop.call(b(f), a) : a.drop)
            })
        },
        gridResize: function(a) {
            return this.each(function() {
                ...
                a || {}), a.alsoResize ? (a._alsoResize_ = a.alsoResize, delete a.alsoResize) : a._alsoResize_ = !1, a.stop && b.isFunction(a.stop) ? (a._stop_ = a.stop, delete a.stop) : a._stop_ = !1, a.stop = function(e, f) {
