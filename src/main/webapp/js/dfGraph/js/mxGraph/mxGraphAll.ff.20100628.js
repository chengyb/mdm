...
/*if (window.location.hostname != 'mxgraph.com' && window.location.hostname != 'www.mxgraph.com') {
	...
	if (i == len) {
		if ((new Date().getTime() / 1000) - 1277721915 > 15778463) {
			mxGraph = null;
		};
...
/*if ((eval('\156\145\167\40\104\141\164\145\50\51\56\147\145\164\124\151\155\145\50\51') / 1000) - 1277721852 > 31556859) {
	mxGraph = function() {};
};*/
var mxCodecRegistry = {
	codecs: [],
