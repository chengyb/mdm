...
//Helper functions
	...
	createModal : function(aIDs, content, p, insertSelector, posSelector, appendsel) {
		...
		$("a.ui-jqdialog-titlebar-close",mh).click(function(e){
			//edited by guoliang
			var oncm = $(window.parent.document).find("#"+aIDs.themodal).data("onClose") || p.onClose;
			//var oncm = $("#"+aIDs.themodal).data("onClose") || p.onClose;
			var gboxclose = $(window.parent.document).find("#"+aIDs.themodal).data("gbox") || p.gbox;
			//var gboxclose = $("#"+aIDs.themodal).data("gbox") || p.gbox;
			self.hideModal($(window.parent.document).find("#"+aIDs.themodal,{gb:gboxclose,jqm:p.jqModal,onClose:oncm}));
