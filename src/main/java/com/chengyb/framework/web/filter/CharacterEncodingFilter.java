 ...
 *
 */
public class CharacterEncodingFilter extends org.springframework.web.filter.OncePerRequestFilter {
	private String encoding;

	private String enclude;//排除的路径

	public void setEnclude(String enclude) {
...
//		LicenseManager.validateLicense();
		...
		if (enclude!=null && url.indexOf(enclude) < 0) {
